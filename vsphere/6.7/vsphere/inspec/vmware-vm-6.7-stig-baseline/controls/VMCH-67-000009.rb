...
Settings. Review the VMs hardware and verify no CD/DVD drives are connected.
...
server, run the following command:
    ...
    Get-VM | Get-CDDrive | Where {$_.extensiondata.connectable.connected -eq
$true} | Select Parent,Name
