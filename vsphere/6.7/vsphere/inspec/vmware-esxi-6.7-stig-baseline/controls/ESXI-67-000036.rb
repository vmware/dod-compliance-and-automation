...
through the vSphere client."
  ...
  tag rid: "ESXI-67-000036"
  tag stig_id: "ESXI-67-000036"
  tag cci: "CCI-000381"
  tag nist: ["CM-7 a", "Rev_4"]
  desc 'check', "From the vSphere Client select the ESXi Host and go to Configure
>> System >> Services. Under Services select Edit and view the \"ESXi Shell\"
service and verify it is stopped.
...
System >> Services. Under Services select ESXi Shell service and click the Stop
