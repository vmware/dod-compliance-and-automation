...
>> System >> Advanced System Settings. Select the Annotations.WelcomeMessage
value and verify it contains the DoD logon banner to follow.
...
finding."
  desc 'fix', "From a PowerCLI command prompt while connected to the ESXi host
