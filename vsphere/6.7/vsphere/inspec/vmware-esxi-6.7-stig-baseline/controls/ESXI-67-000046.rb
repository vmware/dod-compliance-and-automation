...
>> System >> Time Configuration. Click Edit to verify the configured NTP
servers and service startup policy.
...
If the NTP service is not configured with authoritative DoD time sources or the
...
System >> Time Configuration. Click Edit to configure the NTP service to start
and stop with the host and with authoritative DoD time sources.
