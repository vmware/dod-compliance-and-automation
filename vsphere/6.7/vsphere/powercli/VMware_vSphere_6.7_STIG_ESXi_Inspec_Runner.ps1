<# 
.SYNOPSIS 
    Inspec runner for the vSphere 6.7 ESXi STIG
.DESCRIPTION
...
.NOTES 
    File Name  : VMware_vSphere_6.7_STIG_ESXi_Inspec_Runner.ps1 
    Author     : Ryan Lakey
    Version    : 1.0
...
Try{
    ForEach($vmhost in $vmhosts){
        $name = $vmhost.Name
        $reportFile = $reportPath + "\VMware_vSphere_6.7_STIG_ESXi_Inspec_Report" + "_" + $name + "-" + $Date.Month + "-" + $Date.Day + "-" + $Date.Year + "_" + $Date.Hour + "-" + $Date.Minute + "-" + $Date.Second + ".json"
        ...
        If(Get-Command inspec_tools){
            ...
            $cklFile = $reportPath + "\VMware_vSphere_6.7_STIG_ESXi_Inspec_Report" + "_" + $name + "-" + $Date.Month + "-" + $Date.Day + "-" + $Date.Year + "_" + $Date.Hour + "-" + $Date.Minute + "-" + $Date.Second + ".ckl"
