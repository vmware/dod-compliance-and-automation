...
suspicious activity to go unlogged.
    ...
    On the VCSA, the \"vmware-vmon\" service starts up the Java virtual
machines (JVMs) for various vCenter processes, including Performance Charts,
and the individual \"json\" config files control the early JVM logging.
Ensuring these \"json\" files are configured correctly enables early Java
...
\"%VMWARE_LOG_DIR%/vmware/perfcharts/vmware-perfcharts-runtime.log\",
  ...
  tag cci: %w(CCI-000163 CCI-000169 CCI-001464)
