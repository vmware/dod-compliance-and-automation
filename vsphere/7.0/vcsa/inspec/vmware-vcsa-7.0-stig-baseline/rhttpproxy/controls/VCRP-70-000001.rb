...
can consume resources that might otherwise be required by active connections.
It is a best practice to terminate connections that are no longer connected to
an active client.

    Envoy is hard coded to drop connections after three minutes of idle time.
The absence of any \"tcpKeepAliveTimeSec\" settings means that this default is
effect. This configuration must be verified and maintained.
  "
  desc  'rationale', ''
  desc  'check', "
...
<tcpKeepAliveTimeSec> as follows:
