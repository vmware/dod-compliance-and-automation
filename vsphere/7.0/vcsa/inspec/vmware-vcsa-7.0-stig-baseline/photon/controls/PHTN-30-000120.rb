...
LoginGraceTime."
  desc  "By default, sshd unauthenticated connections are left open for two
...
the exposure any partial login attempts may create."
  desc  'rationale', ''
  desc  'check', "
...
\"LoginGraceTime\" line is uncommented and set to the following:
