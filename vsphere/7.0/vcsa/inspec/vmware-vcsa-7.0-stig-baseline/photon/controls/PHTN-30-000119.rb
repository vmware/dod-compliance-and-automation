...
control 'PHTN-30-000119' do
  ...
  AllowTcpForwarding."
    desc  "While enabling TCP tunnels is a valuable function of sshd, this
  feature is not appropriate for use on single purpose appliances."
    desc  'rationale', ''
    desc  'check', "
  ...
  \"AllowTcpForwarding\" line is uncommented and set to the following:
