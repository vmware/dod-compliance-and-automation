...
attacks might be successful. As such, Lookup Service must be configured to hide
the server version at all times.
  "
  desc  'rationale', ''
  desc  'check', "
    ...
    # xmllint --xpath
'/Server/Service/Connector[@port=\"${bio-custom.http.port}\"]/@server'
