...
will display to the user a listing of the files in the directory being accessed.
...
index.jsp (or equivalent) file is one approach to mitigating the vulnerability.
  "
  desc  'rationale', ''
  desc  'check', "
