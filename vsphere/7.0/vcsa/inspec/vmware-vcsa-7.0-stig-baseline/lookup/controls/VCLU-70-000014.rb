...
control 'VCLU-70-000014' do
  title "Lookup Service must not have the Web Distributed Authoring (WebDAV)
servlet installed."
...
excessive number of vulnerabilities, this servlet must not be installed. Lookup
Service does not configure WebDAV by default.
  "
  desc  'rationale', ''
  desc  'check', "
