...
control 'VCLU-70-000024' do
  title "Lookup Service must be configured to show error pages with minimal
information."
...
might be successful. As such, Lookup Service must be configured to not show
