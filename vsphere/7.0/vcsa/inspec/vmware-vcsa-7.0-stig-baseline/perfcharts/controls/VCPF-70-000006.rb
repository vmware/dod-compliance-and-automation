...
and the individual json config files control the early JVM logging. Ensuring
these json files are configured correctly enables early java \"stdout\" and
\"stderr\" logging.
  "
  desc  'rationale', ''
  desc  'check', "
