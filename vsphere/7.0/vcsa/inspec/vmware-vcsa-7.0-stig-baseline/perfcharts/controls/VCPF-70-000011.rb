control 'VCPF-70-000011' do
  ...
  desc  'The "package.access" entry in the "catalina.properties" file implements access control at the package level. When properly configured, a Security Exception will be reported should an errant or malicious webapp attempt to access the listed internal classes directly, or if a new class is defined under the protected packages. Performance Charts comes pre-configured with the appropriate packages defined in "package.access" and this configuration must be maintained. '
  desc  'rationale', ''
  desc  'check', "
