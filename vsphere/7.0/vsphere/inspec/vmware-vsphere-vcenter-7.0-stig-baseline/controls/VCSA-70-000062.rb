...
Configuration >> Login Message
    ...
    If selection boxes next to \"Show login message\" is disabled or if
\"Details of login message\" is not configured to the standard DoD User
Agreement, this is a finding.
...
Agreement\". Click the \"Consent checkbox\" slider to enable. Set the \"Details
of login message\" to the standard DoD User Agreement text. Click \"Save\".
