...
control 'VCSA-70-000042' do
  title "The vCenter Server passwords must contain at least one numeric
character."
...
Numeric Characters to at least \"1\" and click \"Save\"."
  impact 0.5
  tag severity: 'medium'
  tag gtitle: 'SRG-APP-000168'
  tag gid: nil
  tag rid: nil
  tag stig_id: 'VCSA-70-000042'
  tag fix_id: nil
  tag cci: 'CCI-000194'
  tag nist: ['IA-5 (1) (a)']
