...
locked due to excessive login failures."
  desc  "By requiring that SSO accounts be manually unlocked, the risk of
unauthorized access via user password guessing, otherwise known as
brute-forcing, is reduced. When the account unlock time is set to zero, once an
account is locked it can only be unlocked manually by an administrator."
  desc  'rationale', ''
  desc  'check', "
