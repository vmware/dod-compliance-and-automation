...
\"Syslog.global.logDir\" value and verify it is set to a persistent location.
    ...
    If the value of the setting is \"[] /scratch/logs\", verify that the
advanced setting \"ScratchConfig.CurrentScratchLocation\" is not set to
\"/tmp/scratch\". This is a non-persistent location.

    If \"Syslog.global.logDir\" is not configured to a persistent location,
this is a finding.
...
example:
    ...
    Where 51dda02d-fade5016-8a08-005056171889 is the UUID of the target
datastore.
