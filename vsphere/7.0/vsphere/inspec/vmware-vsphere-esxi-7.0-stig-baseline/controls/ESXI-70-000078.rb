...
host has in the vCenter Server inventory.
    ...
    From the vSphere Web Client, select the ESXi host's vCenter Server >>
Configure >> System >> Advanced Settings. Select the \"vpxd.certmgmt.mode\"
value and make sure it is set to \"custom\".
