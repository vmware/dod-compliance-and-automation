...
Properties >> Authentication >> Method and view the CHAP configuration and
verify CHAP is required for target and host authentication.
...
to Use bidirectional CHAP and enter a unique secret for
