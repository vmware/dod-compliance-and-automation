...
of vCenter. It is accessed by browing to \"https://<ESX FQDN>/ui\". ESXi is not
usually administered via this interface for long periods and all users will be
highly privileged. Implementing a mandatory session idle limit will ensure that
orphaned, forgotten or ignored sessions will be closed promptly."
  desc  'rationale', ''
  desc  'check', "
...
\"UserVars.HostClientSessionTimeout\" value and verify it is set to \"600\".
...
following command:
    ...
    If the \"UserVars.HostClientSessionTimeout\" setting is not set to \"600\",
this is a finding
  "
  desc  'fix', "
    Fom the vSphere Client go to Hosts and Clusters >> Select the ESXi Host >>
Configure >> System >> Advanced System Settings. Select the
\"UserVars.HostClientSessionTimeout\" value and set it to \"600\".
