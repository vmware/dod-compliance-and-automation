...
modules to protect the confidentiality of remote access sessions."
  desc  "OpenSSH on the ESXi host ships with a FIPS 140-2 validated cryographic
module and it is enabled by default. For backward compatibility reasons, this
can be disabled so this setting must be audited and corrected if necessary.
