...
while Nexus switches typically reserve 3968 4094. Check with the
documentation for your specific switch. Using a reserved VLAN might result in a
...
the \"VLAN ID\" on each port group and verify it is not set to a reserved VLAN
ID.
...
the port group. Click \"Edit Settings\". On the \"Properties\" tab, change the
