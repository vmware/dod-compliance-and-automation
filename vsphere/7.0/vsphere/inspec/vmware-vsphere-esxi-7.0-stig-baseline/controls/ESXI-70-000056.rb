...
Configure >> System >> Firewall. Under the \"Allowed IP addresses\" column,
review the allowed IPs for each service. Check this for \"Incoming\" and
\"Outgoing\" sections.
...
address and input the site specific network(s) required.
