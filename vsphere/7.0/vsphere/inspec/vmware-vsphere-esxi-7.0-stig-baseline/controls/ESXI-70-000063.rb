...
other than that of the native VLAN."
  desc  "ESXi does not use the concept of native VLAN. Frames with a VLAN
...
the \"VLAN ID\" on each port group. Verify they are not set to the native VLAN
ID of the attached physical switch.
...
\"VLAN ID\" to a non-native VLAN and click \"OK\".
