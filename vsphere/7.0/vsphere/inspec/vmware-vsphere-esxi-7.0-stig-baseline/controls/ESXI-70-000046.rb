...
Configure >> System >> Time Configuration. Under \"Current Time
Configuration\", verify that \"Time Synchronization\" is set to \"Network Time
Protocol\". Under \"Network Time Protocol\", ensure that the \"NTP Servers\"
are authorized DoD time sources.

    If the ESXi host is not configured to pull time from authoritative DoD time
sources, this is a finding.
...
sources. Ensure that the \"NTP Service Startup Policy\" is set to \"Start and
stop with host\". Ensure that the \"Enable\" checkbox is ticker, in the upper
left. Click \"OK\".

    Click Edit to configure the NTP service to start and stop with the host and
with authoritative DoD time sources.
