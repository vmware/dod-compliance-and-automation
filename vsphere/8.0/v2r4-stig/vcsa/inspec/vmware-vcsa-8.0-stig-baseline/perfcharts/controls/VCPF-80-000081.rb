control 'VCPF-80-000081' do
  title 'The vCenter Perfcharts service must off-load log records onto a different system or media from the system being logged.'
  desc  "
  ...
  tag gid: 'V-VCPF-80-000081'
  tag rid: 'SV-VCPF-80-000081'
  tag stig_id: 'VCPF-80-000081'
  tag cci: ['CCI-001851']
  tag nist: ['AU-4 (1)']

  goodcontent_v1 = inspec.profile.file('vmware-services-perfcharts-v1.conf')
  goodcontent_v2 = inspec.profile.file('vmware-services-perfcharts-v2.conf')

  describe.one do
    describe file('/etc/vmware-syslog/vmware-services-perfcharts.conf').content.strip do
