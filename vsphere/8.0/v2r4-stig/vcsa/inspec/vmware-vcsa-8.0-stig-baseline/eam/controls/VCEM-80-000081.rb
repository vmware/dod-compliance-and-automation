control 'VCEM-80-000081' do
  title 'The vCenter ESX Agent Manager service must off-load log records onto a different system or media from the system being logged.'
  desc  "
  ...
  tag gid: 'V-259016'
  tag rid: 'SV-259016r1210396_rule'
