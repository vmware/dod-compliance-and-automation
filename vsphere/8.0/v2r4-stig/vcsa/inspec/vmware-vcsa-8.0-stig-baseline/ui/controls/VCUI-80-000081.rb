control 'VCUI-80-000081' do
  title 'The vCenter UI service must off-load log records onto a different system or media from the system being logged.'
  ...
  desc  'rationale', ''
  desc  'check', "
    By default, a vmware-services-vsphere-ui.conf rsyslog configuration file includes the service logs when syslog is configured on vCenter, but it must be verified.
  ...
  tag gid: 'V-259117'
  tag rid: 'SV-259117r1210442_rule'
