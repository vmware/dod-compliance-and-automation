control 'VCST-80-000138' do
  title 'The vCenter STS service deployXML attribute must be disabled.'
...
# xmllint --xpath "//Host/@deployXML" /usr/lib/vmware-sso/vmware-sts/conf/server.xml
...
# vmon-cli --restart sts'
  impact 0.5
  tag check_id: 'C-70060r1003675_chk'
  tag severity: 'medium'
  tag gid: 'V-266136'
  tag rid: 'SV-266136r1003677_rule'
  tag stig_id: 'VCST-80-000138'
  tag gtitle: 'SRG-APP-000141-AS-000095'
  tag fix_id: 'F-69963r1003676_fix'
  tag cci: ['CCI-000381']
  tag nist: ['CM-7 a']
