control 'VCLD-80-000022' do
  ...
  desc  'check', "
    ...
    input(type=\"imfile\"
          File=\"/var/log/vmware/applmgmt/applmgmt_vmonsvc.stdout\"
          ...
          reopenOnTruncate=\"on\")
    input(type=\"imfile\"
          File=\"/var/log/vmware/applmgmt/applmgmt_vmonsvc.stderr\"
          Tag=\"applmgmt_vmonsvc\"
          Severity=\"info\"
          Facility=\"local0\"
          deleteStateOnFileDelete=\"on\"
  ...
  goodcontent_v1 = inspec.profile.file('vmware-services-applmgmt-v1.conf')
  goodcontent_v2 = inspec.profile.file('vmware-services-applmgmt-v2.conf')
