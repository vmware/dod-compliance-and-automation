control 'VCRP-80-000073' do
  ...
  goodcontent_v1 = inspec.profile.file('vmware-services-rhttpproxy-v1.conf')
  goodcontent_v2 = inspec.profile.file('vmware-services-rhttpproxy-v2.conf')

  describe.one do
    describe file('/etc/vmware-syslog/vmware-services-rhttpproxy.conf').content.strip do
