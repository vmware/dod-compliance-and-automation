control 'PHTN-40-000267' do
  title 'The Photon operating system must be configured to use the pam_deny.so module.'
  desc  'By requiring the use of the pam_deny.so module, any authentication attempt that does not explicitly succeed with a previous PAM module will be denied. This ensures that no unhandled or ambiguous authentication paths allow unintended access, thereby enforcing a fail-safe mechanism against unauthorized system logins.'
  desc  'rationale', ''
  desc  'check', "
  ...
  tag gid: 'V-PHTN-40-000267'
  tag rid: 'SV-PHTN-40-000267'
  tag stig_id: 'PHTN-40-000267'
  tag cci: ['CCI-000366']
  tag nist: ['CM-6 b']
