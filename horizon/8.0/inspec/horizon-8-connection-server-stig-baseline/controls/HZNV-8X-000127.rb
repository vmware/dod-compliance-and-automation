control 'HZNV-8X-000127' do
  title 'The Horizon Connection Server HTTPS Secure Tunnel must validate client and administrator certificates.'
  desc  "
  ...
  desc  'rationale', ''
  desc  'check', "
    If the HTTPS Secure Tunnel setting is not enabled, this control is not applicable.
  ...
  tag gid: 'V-HZNV-8X-000127'
  tag rid: 'SV-HZNV-8X-000127'
