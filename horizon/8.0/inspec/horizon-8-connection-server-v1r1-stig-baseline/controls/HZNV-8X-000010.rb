...
control "HZNV-8X-000010" do
  ...
  desc  "fix", "
    ...
    Note: Horizon Connection Server supports MSSQL, Oracle, and PostgreSQL database types. Consult VMware documentation for more detailed database setup information and minimum required privileges.
  "
  impact 0.5
  tag severity: "medium"
  ...
  tag gid: "V-HZNV-8X-000010"
  tag rid: "SV-HZNV-8X-000010"
