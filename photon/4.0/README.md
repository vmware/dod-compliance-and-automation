# VMware Photon OS 4.0 STIG Compliance and Automation
...
The VMware Photon OS 4.0 Security Technical Implementation Guides (STIGs) provide security policy and configuration requirements for the use of Photon OS 4.0 in the Department of Defense (DoD). The Photon OS 4.0 STIG is based on the General Purpose Operating System (GPOS) SRG V2R5.
