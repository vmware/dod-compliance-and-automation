...
The VMware Photon OS 5.0 Security Technical Implementation Guides (STIGs) provide security policy and configuration requirements for the use of Photon OS 5.0 in the Department of Defense (DOD). The Photon OS 5.0 STIG is based on the General Purpose Operating System (GPOS) SRG.
