control 'UBTU-24-100400' do
  title 'Ubuntu 24.04 LTS must have the "auditd" package installed.'
...
$ sudo apt install -y auditd'
  impact 0.5
  tag check_id: 'C-74689r1067146_chk'
  tag severity: 'medium'
  tag gid: 'V-270656'
  tag rid: 'SV-270656r1067148_rule'
  tag stig_id: 'UBTU-24-100400'
  tag gtitle: 'SRG-OS-000365-GPOS-00152'
  tag fix_id: 'F-74590r1067147_fix'
