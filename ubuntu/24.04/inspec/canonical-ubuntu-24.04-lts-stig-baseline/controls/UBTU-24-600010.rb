...
$ sudo systemctl restart ssh'
  ...
  tag severity: 'medium'
  tag gid: 'V-270743'
  tag rid: 'SV-270743r1208702_rule'
  tag stig_id: 'UBTU-24-600010'
  tag gtitle: 'SRG-OS-000163-GPOS-00072'
  tag fix_id: 'F-74677r1208701_fix'
  tag 'documentable'
  tag cci: ['CCI-001133']
  tag nist: ['SC-10']
