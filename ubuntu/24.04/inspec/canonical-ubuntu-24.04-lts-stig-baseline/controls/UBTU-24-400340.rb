control 'UBTU-24-400340' do
  ...
  desc 'check', 'Note: If smart card authentication is not being used on the system, this requirement is not applicable.
...
Note: It is valid for this configuration to be in a file with a name that ends with ".conf" and does not begin with a "." in the "/etc/sssd/conf.d/" directory instead of the "/etc/sssd/sssd.conf" file.'
  impact 0.3
  tag check_id: 'C-74767r1155220_chk'
  tag severity: 'low'
  tag gid: 'V-270734'
