control 'UBTU-24-600130' do
  title 'Ubuntu 24.04 LTS must ensure only users who need access to security functions are part of sudo group.'
...
Ubuntu 24.04 LTS restricts access to security functions through the use of access control mechanisms and by implementing least privilege capabilities.'
  desc 'check', 'Verify the sudo group has only members who require access to security functions with the following command:
...
$ sudo gpasswd -d <username> sudo'
  ...
  tag severity: 'high'
  tag gid: 'V-270748'
  tag rid: 'SV-270748r1066733_rule'
  tag stig_id: 'UBTU-24-600130'
  tag gtitle: 'SRG-OS-000134-GPOS-00068'
  tag fix_id: 'F-74682r1066732_fix'
  tag 'documentable'
  tag cci: ['CCI-001084']
  tag nist: ['SC-3']
