control 'UBTU-24-900270' do
  title 'Ubuntu 24.04 LTS must generate audit records for successful/unsuccessful uses of the passwd command.'
  desc 'Without generating audit records specific to the security and mission needs of the organization, it would be difficult to establish, correlate, and investigate the events relating to an incident or identify those responsible for one.

Audit records can be generated from various components within the information system (e.g., module or policy filter).'
  desc 'check', 'Verify that an audit event is generated for any successful/unsuccessful use of the "passwd" command with the following command:
...
$ sudo augenrules --load'
  impact 0.5
  tag check_id: 'C-74831r1068381_chk'
  tag severity: 'medium'
  tag gid: 'V-270798'
  tag rid: 'SV-270798r1068382_rule'
  tag stig_id: 'UBTU-24-900270'
  tag gtitle: 'SRG-OS-000064-GPOS-00033'
  tag fix_id: 'F-74732r1066882_fix'
  tag 'documentable'
  tag cci: ['CCI-000172']
  tag nist: ['AU-12 c']
