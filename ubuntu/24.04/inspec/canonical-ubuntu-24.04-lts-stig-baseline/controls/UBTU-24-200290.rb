control 'UBTU-24-200290' do
  title 'Ubuntu 24.04 LTS must generate audit records for all account creations, modifications, disabling, and termination events that affect /etc/group.'
...
'
  desc 'check', 'Verify Ubuntu 24.04 LTS generates audit records for all account creations, modifications, disabling, and termination events that affect "/etc/group" with the following command:
...
Note: The "-k" allows for specifying an arbitrary identifier, and the string after it does not need to match the example output above.'
  desc 'fix', 'Configure Ubuntu 24.04 LTS to generate audit records for all account creations, modifications, disabling, and termination events that affect "/etc/group".
...
$ sudo augenrules --load'
  impact 0.5
  tag check_id: 'C-74718r1066542_chk'
  tag severity: 'medium'
  tag gid: 'V-270685'
  tag rid: 'SV-270685r1066544_rule'
  tag stig_id: 'UBTU-24-200290'
  tag gtitle: 'SRG-OS-000004-GPOS-00004'
  tag fix_id: 'F-74619r1066543_fix'
