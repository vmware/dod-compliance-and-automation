...
Audit records can be generated from various components within the information system (e.g., module or policy filter).'
  desc 'check', 'Verify Ubuntu 24.04 LTS generates an audit record upon successful/unsuccessful attempts to use the "chacl" command with the following command:
...
$ sudo augenrules --load'
  impact 0.5
  tag check_id: 'C-74828r1066872_chk'
  tag severity: 'medium'
  tag gid: 'V-270795'
  tag rid: 'SV-270795r1066874_rule'
  tag stig_id: 'UBTU-24-900240'
  tag gtitle: 'SRG-OS-000064-GPOS-00033'
  tag fix_id: 'F-74729r1066873_fix'
  tag 'documentable'
  tag cci: ['CCI-000172']
  tag nist: ['AU-12 c']
