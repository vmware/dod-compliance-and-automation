control 'V-219192' do
  ...
  tag "ia_controls": nil
  desc 'check', "Verify that the Ubuntu operating system configures the /var/log/syslog file
  ...
  "
  desc 'fix', "Configure the Ubuntu operating system to have adm group-own the /var/log/syslog
