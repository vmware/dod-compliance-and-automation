control 'V-219181' do
  ...
  tag "ia_controls": nil
  desc 'check', "Verify if the pwquality configuration file enforces a minimum 15-character
  ...
  desc 'fix', "Configure the Ubuntu operating system to enforce a minimum 15-character
    password length.
