...
successful/unsuccessful attempts to use of the \"umount\" command occur.
    ...
    -a always,exit -F path=/bin/umount -F perm=x -F auid>=1000 -F auid!=-1 -k
privileged-umount
...
file:
    ...
    -a always,exit -F path=/bin/umount -F perm=x -F auid>=1000 -F
...
/etc/audit/rules.d/ directory.
  ...
  tag gid: 'V-219241'
  tag rid: 'SV-219241r508662_rule'
  tag stig_id: 'UBTU-18-010318'
  tag fix_id: 'F-20965r305052_fix'
  tag cci: %w(SV-109813 V-100709 CCI-000172)
  tag nist: ['AU-12 c']
