control "V-219234" do
  title "The Ubuntu operating system must be configured so that audit configuration
    files are not write-accessible by unauthorized users."
  ...
  desc "check", "Verify that \"/etc/audit/audit.rules\", \"/etc/audit/rules.d/*\" and
    ...
    If \"/etc/audit/audit.rule\",\"/etc/audit/rules.d/*\" or \"/etc/audit/auditd.conf\" file
