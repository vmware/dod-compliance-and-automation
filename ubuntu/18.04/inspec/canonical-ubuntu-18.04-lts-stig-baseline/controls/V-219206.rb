control "V-219206" do
  ...
  tag "ia_controls": nil
  desc "check", "Verify the system commands contained in the following directories are owned by root:
  ...
  "
  desc "fix", "Configure the system commands - and their respective parent directories - to
