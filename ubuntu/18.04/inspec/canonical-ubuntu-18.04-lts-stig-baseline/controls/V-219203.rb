control "V-219203" do
  ...
  tag "ia_controls": nil
  desc "check", "Verify the system-wide library directories \"/lib\", \"/lib64\"
    and \"/usr/lib\" are group-owned by root.

    Check that the system-wide library directories are group-owned by root with the
    following command:
  ...
  desc "fix", "Configure the system library directories to be protected from
