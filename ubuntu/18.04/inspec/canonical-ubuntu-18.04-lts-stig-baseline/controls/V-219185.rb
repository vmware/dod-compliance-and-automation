control 'V-219185' do
  ...
  tag "ia_controls": nil
  desc 'check', "Verify that \"/etc/sudoers\" has no occurrences of \"NOPASSWD\" or
    \"!authenticate\".
    ...
    If any occurrences of \"NOPASSWD\" or \"!authenticate\" return from the command,
    this is a finding.
  "
