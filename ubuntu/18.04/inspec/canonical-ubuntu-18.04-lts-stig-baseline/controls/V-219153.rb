control 'V-219153' do
  title "The Ubuntu operating system audit event multiplexor must be configured to
  ...
  tag "ia_controls": nil
  desc 'check', "Verify the audit event multiplexor is configured to off-load audit records
    ...
    If the remote_server parameter is not set or is set with a local address, or is set with
