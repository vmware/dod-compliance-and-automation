control 'V-219194' do
  title 'The Ubuntu operating system must configure /var/log/syslog file with mode 0640
    or less permissive.'
  ...
  tag "ia_controls": nil
  desc 'check', "Verify that the Ubuntu operating system configures the /var/log/syslog
    file with mode 0640 or less permissive.
  ...
  desc 'fix', "Configure the Ubuntu operating system to have permissions of 0640 o for the
