control 'V-219199' do
  ...
  tag "gid": 'V-219199'
  tag "rid": 'SV-219199r379246_rule'
  tag "stig_id": 'UBTU-18-010134'
  tag "fix_id": 'F-20923r304926_fix'
  tag "cci": [ "CCI-001499" ]
  tag "nist": nil
  ...
  desc 'check', "Verify the system-wide shared library directories \"/lib\", \"/lib64\"
    and \"/usr/lib have mode 0755 or less permissive.

    Check that the system-wide shared library directories have mode 0755 or less permissive
  ...
  "
  desc 'fix', "Configure the shared library directories to be protected from unauthorized
