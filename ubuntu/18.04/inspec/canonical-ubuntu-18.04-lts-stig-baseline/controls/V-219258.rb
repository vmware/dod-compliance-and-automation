control 'V-219258' do
  ...
  tag "satisfies": nil
  tag "gid": 'V-219258'
  tag "rid": "SV-219258r378727_rule"
  tag "stig_id": "UBTU-18-010335"
  tag "fix_id": "F-20982r305103_fix"
  tag "cci": [ "CCI-000172" ]
  tag "nist": nil
  ...
  "
  desc 'fix', "Configure the audit system to generate an audit event for any unsuccessful use of
