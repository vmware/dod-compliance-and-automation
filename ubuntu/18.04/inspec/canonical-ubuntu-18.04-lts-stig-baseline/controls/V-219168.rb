control 'V-219168' do
  ...
  desc 'check', "Verify the Ubuntu operating system prevents direct logins to the root account.
    ...
    Check that the Ubuntu operating system prevents direct logins to the root account with
    ...
    If the output does not contain \"L\" in the second field to indicate the account is
    locked, this is a finding.
  "
  desc 'fix', "Configure the Ubuntu operating system to prevent direct logins to the root
