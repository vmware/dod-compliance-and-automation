control 'V-219260' do
  ...
  tag "satisfies": nil
  tag "gid": 'V-219260'
  tag "rid": "SV-219260r378727_rule"
  tag "stig_id": "UBTU-18-010337"
  tag "fix_id": "F-20984r305109_fix"
  tag "cci": [ "CCI-000172" ]
  tag "nist": nil
  ...
  tag "ia_controls": nil
  desc 'check', "Verify the Ubuntu operating system generates an audit record when unsuccessful
    attempts to use the \"creat\" system call.
  ...
  "
  desc 'fix', "Configure the audit system to generate an audit event for any unsuccessful
