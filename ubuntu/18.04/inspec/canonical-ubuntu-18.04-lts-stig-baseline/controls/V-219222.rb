control 'V-219222' do
  ...
  desc  "Without generating audit records that are specific to the security and
    ...
    rmation system (e.g., module or policy filter).
  "
  impact 0.5
  tag "gtitle": "SRG-OS-000476-GPOS-00221"
  tag "satisfies": nil
  tag "gid": 'V-219222'
  tag "rid": "SV-219222r381490_rule"
  ...
  tag "ia_controls": nil
  desc 'check', "Verify the Ubuntu operating system generates audit records for all
    account creations, modifications, disabling, and termination events that affect /etc/gshadow.
  ...
  desc 'fix', "Configure the Ubuntu operating system to generate audit records for all
    ...
    Note:
    The \"root\" account must be used to view/edit any files in the /etc/audit/rules.d/
    directory.
