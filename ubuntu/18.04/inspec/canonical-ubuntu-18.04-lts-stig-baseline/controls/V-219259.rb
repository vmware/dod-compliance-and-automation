control 'V-219259' do
  ...
  tag "satisfies": nil
  tag "gid": 'V-219259'
  tag "rid": "SV-219259r378727_rule"
  tag "stig_id": "UBTU-18-010336"
  tag "fix_id": "F-20983r305106_fix"
  tag "cci": [ "CCI-000172" ]
  tag "nist": nil
  ...
  desc 'check', "Verify the Ubuntu operating system generates an audit record when unsuccessful
    attempts to use the \"ftruncate\" system call.
