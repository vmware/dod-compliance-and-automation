control 'V-219174' do
  ...
  desc 'check', "Verify the Ubuntu operating system enforces password complexity by requiring
    ...
    Determine if the field \"dcredit\" is set in the \"/etc/security/pwquality.conf\" file
  ...
  desc 'fix', "Configure the Ubuntu operating system to enforce password complexity by
    ...
    Add or update the \"/etc/security/pwquality.conf\" file to contain the \"dcredit\"
    parameter:
