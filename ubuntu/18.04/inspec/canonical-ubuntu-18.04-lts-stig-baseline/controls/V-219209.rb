control "V-219209" do
  ...
  desc "check", "Verify the system commands directories are group-owned by root:
    ...
    If any system commands directories are returned that are not Set Group ID up
    on execution (SGID) files and owned by a privileged account, this is a finding.
  "
