control 'V-219318' do
  ...
  tag "ia_controls": nil
  desc 'check', "Verify the Ubuntu operating system has the packages required for
    multifactor authentication installed.

    Check for the presence of the packages required to support multifactor authentication
  ...
  "
  desc 'fix', "Configure the Ubuntu operating system to implement multifactor authentication
