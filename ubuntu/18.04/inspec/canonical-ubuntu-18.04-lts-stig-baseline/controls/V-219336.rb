control 'V-219336' do
  title "The Ubuntu operating system must use cryptographic mechanisms to protect
  ...
  desc 'check', "Verify that Advanced Intrusion Detection Environment (AIDE)
    is properly configured to use cryptographic mechanisms to protect the integrity of audit tools.
    ...
    this is a finding.
  "
  desc 'fix', "Add or update the following selection lines to \"/etc/aide/aide.conf\", in order
