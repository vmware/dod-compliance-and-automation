control 'V-219148' do
  title "Ubuntu operating systems booted with United Extensible Firmware Interface (UEFI)
    implemented must require authentication upon booting into single-user mode and maintenance."
  ...
  tag "ia_controls": nil
  desc 'check', "Verify that an encrypted root password is set. This is only applicable on
  ...
  "
  desc 'fix', "Configure the system to require a password for authentication upon booting
    ...
    Using the hash from the output, modify the \"/etc/grub.d/40_custom\" file with the following
