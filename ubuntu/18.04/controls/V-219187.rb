control 'V-219187' do
  title "The Ubuntu operating system must set a sticky bit on all public directories to
    prevent unauthorized and unintended information transferred via shared system resources."
  ...
  tag "ia_controls": nil
  desc 'check', "Verify that all public (world writeable) directories have the public
    sticky bit set.
  ...
  "
  desc 'fix', "Configure all public directories to have the sticky bit set to prevent
    unauthorized and unintended information transferred via shared system resources.

    Set the sticky bit on all public directories using the command, replace \"[Public Directory]\"
