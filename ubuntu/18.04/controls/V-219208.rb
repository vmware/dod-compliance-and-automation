control "V-219208" do
  ...
  tag "ia_controls": nil
  desc "check", "Verify the system commands contained in the following directories
    are group-owned by root:
    ...
    If any system commands are returned that are not Set Group ID up on execution
