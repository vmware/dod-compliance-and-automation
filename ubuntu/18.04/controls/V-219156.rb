control 'V-219156' do
  title "The Ubuntu operating system must be configured so that Advance package Tool (APT)
  ...
  tag "ia_controls": nil
  desc 'check', "Verify Advance package Tool (APT) is configured to remove all software
    components after updated versions have been installed.

    Check that APT is configured to remove all software components after updating with
    ...
    parameters are not set to \"true\", or are missing, or are commented out, this is a
    finding.
  "

  desc 'fix', "Configure APT to remove all software components after updated versions have
    been installed.
