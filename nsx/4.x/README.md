...
This project contains content for compliance auditing and remediation of the VMware NSX 4.x DoD STIG Baseline.

The VMware NSX 4.x Security Technical Implementation Guides (STIGs) provide security policy and configuration requirements for the use of NSX 4.x in the Department of Defense (DoD).
...
This repo for NSX 4.x is split up between auditing and remediation aspects with playbooks (Ansible) and profiles (InSpec).  
