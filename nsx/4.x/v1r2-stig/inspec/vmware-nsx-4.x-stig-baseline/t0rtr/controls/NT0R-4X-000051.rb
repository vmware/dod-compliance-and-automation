control 'NT0R-4X-000051' do
  ...
  desc 'A malicious platform can use a compromised host in an enclave to launch cyberattacks on third parties. This is a common practice in "botnets", which are a collection of compromised computers using malware to attack other computers or networks. Distributed denial-of-service (DDoS) attacks frequently leverage IP source address spoofing to send packets to multiple hosts that in turn will send return traffic to the hosts with the IP addresses that were forged. This can generate significant amounts of traffic. Therefore, protection measures to counteract IP source address spoofing must be taken. When uRPF is enabled in strict mode, the packet must be received on the interface that the device would use to forward the return packet; thereby mitigating IP source address spoofing.'
...
From the drop-down, set the URPF mode to "Strict" and then click "Save".'
  ...
  tag check_id: 'C-69345r994632_chk'
  tag severity: 'high'
  tag gid: 'V-265428'
  tag rid: 'SV-265428r994634_rule'
  tag stig_id: 'NT0R-4X-000051'
  tag gtitle: 'SRG-NET-000205-RTR-000014'
  tag fix_id: 'F-69253r994633_fix'
  tag 'documentable'
  tag cci: ['CCI-001094']
  tag nist: ['SC-5 (1)']
