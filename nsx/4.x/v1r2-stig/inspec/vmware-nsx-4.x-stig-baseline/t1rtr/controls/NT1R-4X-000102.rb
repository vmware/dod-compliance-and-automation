control 'NT1R-4X-000102' do
  ...
  desc 'check', 'If IPv6 forwarding is not enabled, this is Not Applicable.
...
Note: The default ND profile has a hop limit of 64 and cannot be edited. If required, create a new or edit another existing ND profile to use.'
  ...
  tag check_id: 'C-69521r995283_chk'
  tag severity: 'low'
  tag gid: 'V-265604'
  tag rid: 'SV-265604r995285_rule'
  tag stig_id: 'NT1R-4X-000102'
  tag gtitle: 'SRG-NET-000512-RTR-000012'
  tag fix_id: 'F-69429r995284_fix'
  tag 'documentable'
  tag cci: ['CCI-000366']
  tag nist: ['CM-6 b']
