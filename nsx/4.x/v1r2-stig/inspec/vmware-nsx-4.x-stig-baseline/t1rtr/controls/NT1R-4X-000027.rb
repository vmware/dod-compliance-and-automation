...
If a DHCP profile is configured and not in use, this is a finding.'
  desc 'fix', 'From the NSX Manager web interface, go to Networking >> Connectivity >> Tier-1 Gateways and edit the target Tier-1 gateway.
...
Click "Set DHCP Configuration", select "No Dynamic IP Address Allocation", click "Save", and then close "Editing".'
  ...
  tag check_id: 'C-69446r995058_chk'
  tag severity: 'low'
  tag gid: 'V-265529'
  tag rid: 'SV-265529r999926_rule'
  tag stig_id: 'NT1R-4X-000027'
  tag gtitle: 'SRG-NET-000131-RTR-000035'
  tag fix_id: 'F-69354r999926_fix'
  tag 'documentable'
  tag cci: ['CCI-000381']
  tag nist: ['CM-7 a']
