...
'
  desc 'check', 'From the NSX Manager web interface, navigate to Security >> Policy Management >> Distributed Firewall >> Category Specific Rules >> APPLICATION >> Default Layer3 Section >> Default Layer3 Rule >> Action.

If the Default Layer3 Rule is set to "ALLOW", this is a finding.'
  desc 'fix', 'From the NSX Manager web interface, navigate to Security >> Policy Management >> Distributed Firewall >> Category Specific Rules >> APPLICATION >> Default Layer3 Section >> Default Layer3 Rule and change action to "Drop" or "Reject".
...
Note: Before enabling, ensure the necessary rules to whitelist approved traffic are created and published, or this change may result in loss of communication for workloads.'
  ...
  tag check_id: 'C-69536r993952_chk'
  tag severity: 'medium'
  tag gid: 'V-265619'
  tag rid: 'SV-265619r993954_rule'
  tag stig_id: 'NDFW-4X-000016'
  tag gtitle: 'SRG-NET-000202-FW-000039'
  tag fix_id: 'F-69444r993953_fix'
  tag satisfies: ['SRG-NET-000202-FW-000039', 'SRG-NET-000235-FW-000133']
  tag 'documentable'
  tag cci: ['CCI-001109', 'CCI-001190']
  tag nist: ['SC-7 (5)', 'SC-24']
