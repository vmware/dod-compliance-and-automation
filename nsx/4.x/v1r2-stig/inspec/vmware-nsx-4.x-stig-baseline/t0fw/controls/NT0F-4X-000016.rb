...
Change the Action to "Drop" or "Reject", and then click "Publish".'
  ...
  tag check_id: 'C-69285r994345_chk'
  tag severity: 'medium'
  tag gid: 'V-265368'
  tag rid: 'SV-265368r994347_rule'
  tag stig_id: 'NT0F-4X-000016'
  tag gtitle: 'SRG-NET-000202-FW-000039'
  tag fix_id: 'F-69193r994346_fix'
  tag satisfies: ['SRG-NET-000202-FW-000039', 'SRG-NET-000205-FW-000040', 'SRG-NET-000235-FW-000133', 'SRG-NET-000364-FW-000031']
  tag 'documentable'
