...
'
  desc 'check', 'From an NSX Edge Node shell hosting the Tier-0 Gateway, run the following command:
...
Note: Configure the syslog to send an alert if the events server is unable to receive events from the NSX-T and also if denial-of-service (DoS) incidents are detected. This is true if the events server is STIG compliant.'
  ...
  tag check_id: 'C-69287r994351_chk'
  tag severity: 'medium'
  tag gid: 'V-265370'
  tag rid: 'SV-265370r994353_rule'
  tag stig_id: 'NT0F-4X-000020'
  tag gtitle: 'SRG-NET-000333-FW-000014'
  tag fix_id: 'F-69195r994352_fix'
