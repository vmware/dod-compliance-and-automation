...
If the SSH server is not stopped or starts on boot, this is a finding.'
  desc 'fix', 'From an NSX Manager shell, run the following command(s):

> stop service ssh
> clear service ssh start-on-boot'
  impact 0.5
  ref 'DPMS Target VMware NSX 4.x Manager NDM'
  tag check_id: 'C-69270r994280_chk'
  tag severity: 'medium'
  tag gid: 'V-265353'
  tag rid: 'SV-265353r994282_rule'
  tag stig_id: 'NMGR-4X-000097'
  tag gtitle: 'SRG-APP-000516-NDM-000317'
  tag fix_id: 'F-69178r994281_fix'
  tag 'documentable'
  tag cci: ['CCI-000366']
  tag nist: ['CM-6 b']
