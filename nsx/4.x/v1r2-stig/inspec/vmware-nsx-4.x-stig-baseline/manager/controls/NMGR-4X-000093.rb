...
'
  desc 'check', 'From the NSX Manager web interface, go to System >> Lifecycle Management >> Backup and Restore to view the backup configuration.
...
Enable "Detect NSX configuration change" to trigger backups on detection of configuration changes and specify an interval for detecting changes. Click "Save".'
  ...
  tag check_id: 'C-69267r994271_chk'
  tag severity: 'medium'
  tag gid: 'V-265350'
  tag rid: 'SV-265350r994273_rule'
  tag stig_id: 'NMGR-4X-000093'
  tag gtitle: 'SRG-APP-000516-NDM-000341'
  tag fix_id: 'F-69175r994272_fix'
  tag satisfies: ['SRG-APP-000516-NDM-000341', 'SRG-APP-000516-NDM-000340']
  tag 'documentable'
