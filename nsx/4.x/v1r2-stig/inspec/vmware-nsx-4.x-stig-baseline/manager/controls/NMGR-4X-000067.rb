...
If the output contains unknown or nonauthoritative time sources, this is a finding.'
  desc 'fix', 'To configure a profile to apply NTP servers to all NSX Manager nodes, do the following:
...
> set ntp-server <server-ip or server-name>'
  ...
  tag check_id: 'C-69255r994235_chk'
  tag severity: 'medium'
  tag gid: 'V-265338'
  tag rid: 'SV-265338r994237_rule'
  tag stig_id: 'NMGR-4X-000067'
  tag gtitle: 'SRG-APP-000373-NDM-000298'
  tag fix_id: 'F-69163r994236_fix'
  tag 'documentable'
  tag cci: ['CCI-001893']
  tag nist: ['AU-8 (2)']
