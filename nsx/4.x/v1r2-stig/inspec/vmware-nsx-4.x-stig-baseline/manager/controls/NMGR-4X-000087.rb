...
'
  desc 'check', 'From the NSX Manager web interface, go to System >> Fabric >> Profiles >> Node Profiles.
...
If the log level is not set to INFO, this is a finding.'
  desc 'fix', 'To configure a profile to apply syslog servers to all NSX Manager nodes, do the following:
...
Note: If using the protocols TLS or LI-TLS to configure a secure connection to a log server, the server and client certificates must be stored in /image/vmware/nsx/file-store on each NSX-T Manager appliance.'
  ...
  tag check_id: 'C-69265r994265_chk'
  tag severity: 'high'
  tag gid: 'V-265348'
  tag rid: 'SV-265348r994267_rule'
  tag stig_id: 'NMGR-4X-000087'
  tag gtitle: 'SRG-APP-000515-NDM-000325'
  tag fix_id: 'F-69173r994266_fix'
  tag satisfies: ['SRG-APP-000515-NDM-000325', 'SRG-APP-000357-NDM-000293', 'SRG-APP-000516-NDM-000350']
  tag 'documentable'
  tag cci: ['CCI-001851', 'CCI-001849']
  tag nist: ['AU-4 (1)', 'AU-4']
