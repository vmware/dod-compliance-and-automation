control 'NMGR-4X-000099' do
  title 'The NSX Manager must enable the global FIPS compliance mode for load balancers.'
  ...
  desc 'check', 'From the NSX Manager web interface, go to the Home >> Monitoring Dashboards >> Compliance Report.
...
Caution: Detaching a load balancer from the Tier-1 gateway results in a traffic interruption for the load balancer instance.'
  ...
  tag check_id: 'C-69272r994286_chk'
  tag severity: 'medium'
  tag gid: 'V-265355'
  tag rid: 'SV-265355r994288_rule'
  tag stig_id: 'NMGR-4X-000099'
  tag gtitle: 'SRG-APP-000516-NDM-000317'
  tag fix_id: 'F-69180r994287_fix'
  tag 'documentable'
  tag cci: ['CCI-000366']
  tag nist: ['CM-6 b']
