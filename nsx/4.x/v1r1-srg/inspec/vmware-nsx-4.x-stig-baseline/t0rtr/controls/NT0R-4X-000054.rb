control 'NT0R-4X-000054' do
  title 'The NSX Tier-0 Gateway must be configured to implement message authentication for all control plane protocols.'
  desc  "
  ...
  desc  'check', "
    ...
    Since the NSX Tier-0 Gateway does not reveal if a BGP password is configured, interview the router administrator to determine if a password is configured on BGP neighbors.
  ...
  tag gid: 'V-NT0R-4X-000054'
  tag rid: 'SV-NT0R-4X-000054'
