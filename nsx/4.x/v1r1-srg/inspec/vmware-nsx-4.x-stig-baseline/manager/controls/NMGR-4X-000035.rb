control 'NMGR-4X-000035' do
  ...
  desc  'rationale', ''
  desc  'check', "
    From the NSX Manager web interface, go to the System >> User Management >> Local Users and view the status column.

    If the audit, guestuser1, or guestuser2 local accounts are active, this is a finding.
  "
  desc 'fix', "
    From the NSX Manager web interface, go to the System >> User Management >> Local Users.
  ...
  tag gid: 'V-NMGR-4X-000035'
  tag rid: 'SV-NMGR-4X-000035'
