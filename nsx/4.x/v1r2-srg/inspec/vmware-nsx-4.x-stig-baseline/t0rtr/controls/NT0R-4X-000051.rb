control 'NT0R-4X-000051' do
  title 'The NSX Tier-0 Gateway must be configured to restrict it from accepting outbound IP packets that contain an illegitimate address in the source address field by enabling Unicast Reverse Path Forwarding (uRPF).'
  ...
  tag gid: 'V-NT0R-4X-000051'
  tag rid: 'SV-NT0R-4X-000051'
