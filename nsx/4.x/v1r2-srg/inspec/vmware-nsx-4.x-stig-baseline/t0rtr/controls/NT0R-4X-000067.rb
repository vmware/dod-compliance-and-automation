control 'NT0R-4X-000067' do
  title 'The NSX Tier-0 Gateway must be configured to use the BGP maximum prefixes feature to protect against route table flooding and prefix de-aggregation attacks.'
  desc  "
  ...
  tag gid: 'V-NT0R-4X-000067'
  tag rid: 'SV-NT0R-4X-000067'
