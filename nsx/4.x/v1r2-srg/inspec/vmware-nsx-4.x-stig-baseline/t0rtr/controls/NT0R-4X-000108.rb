control 'NT0R-4X-000108' do
  title 'The NSX Tier-0 Gateway router must be configured to use encryption for BGP routing protocol authentication.'
  desc  "
  ...
  tag gid: 'V-NT0R-4X-000108'
  tag rid: 'SV-NT0R-4X-000108'
