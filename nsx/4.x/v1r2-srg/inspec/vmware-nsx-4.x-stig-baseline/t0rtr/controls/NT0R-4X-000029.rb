control 'NT0R-4X-000029' do
  title 'The NSX Tier-0 Gateway router must be configured to use encryption for OSPF routing protocol authentication.'
  desc  "
  ...
  tag gid: 'V-NT0R-4X-000029'
  tag rid: 'SV-NT0R-4X-000029'
