control 'NT0R-4X-000013' do
  title 'The NSX Tier-0 Gateway must be configured to disable Protocol Independent Multicast (PIM) on all interfaces that are not required to support multicast routing.'
  desc  "
  ...
  tag gid: 'V-NT0R-4X-000013'
  tag rid: 'SV-NT0R-4X-000013'
