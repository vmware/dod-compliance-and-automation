control 'NMGR-4X-000087' do
  ...
  desc 'fix', "
    ...
    Note: If using the protocols TLS or LI-TLS to configure a secure connection to a log server, the server and client certificates must be stored in /image/vmware/nsx/file-store on each NSX Manager appliance.
  "
  impact 0.7
  tag severity: 'high'
  tag gtitle: 'SRG-APP-000515-NDM-000325'
  tag satisfies: ['SRG-APP-000357-NDM-000293', 'SRG-APP-000516-NDM-000350']
  tag gid: 'V-NMGR-4X-000087'
  tag rid: 'SV-NMGR-4X-000087'
