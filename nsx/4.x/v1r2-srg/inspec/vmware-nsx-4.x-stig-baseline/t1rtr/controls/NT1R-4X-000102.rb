control 'NT1R-4X-000102' do
  title 'The NSX Tier-1 Gateway must be configured to advertise a hop limit of at least 32 in Router Advertisement messages for IPv6 stateless auto-configuration deployments.'
  ...
  tag gid: 'V-NT1R-4X-000102'
  tag rid: 'SV-NT1R-4X-000102'
