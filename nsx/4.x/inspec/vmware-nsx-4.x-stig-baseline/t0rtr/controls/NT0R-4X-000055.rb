control 'NT0R-4X-000055' do
  title 'The NSX Tier-0 Gateway must be configured to use a unique key for each autonomous system (AS) with which it peers.'
  ...
  desc  'check', "
    ...
    Since the NSX Tier-0 Gateway does not reveal the current password, interview the router administrator to determine if unique keys are being used.
  ...
  tag gid: 'V-NT0R-4X-000055'
  tag rid: 'SV-NT0R-4X-000055'
