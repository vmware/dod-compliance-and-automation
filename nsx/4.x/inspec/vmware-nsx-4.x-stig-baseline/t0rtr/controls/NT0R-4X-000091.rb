control 'NT0R-4X-000091' do
  title 'The NSX Tier-0 Gateway must be configured to use its loopback address as the source address for iBGP peering sessions.'
  desc  "
  ...
  tag gid: 'V-NT0R-4X-000091'
  tag rid: 'SV-NT0R-4X-000091'
