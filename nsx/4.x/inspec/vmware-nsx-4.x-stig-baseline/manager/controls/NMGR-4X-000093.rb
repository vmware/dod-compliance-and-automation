control 'NMGR-4X-000093' do
  ...
  desc  'rationale', ''
  desc  'check', "
    From the NSX Manager web interface, go to System >> Backup and Restore to view the backup configuration.
  ...
  desc 'fix', "
    ...
    From the NSX Manager web interface, go to System >> Backup and Restore, and then click \"Edit\" next to SFTP Server.
    ...
    From the NSX Manager web interface, go to System >> Backup and Restore, and then click \"Edit\" next to Schedule.
  ...
  tag gid: 'V-NMGR-4X-000093'
  tag rid: 'SV-NMGR-4X-000093'
  tag stig_id: 'NMGR-4X-000093'
