control 'NMGR-4X-000094' do
  ...
  desc 'fix', "
    ...
    This can be done individually by generating CSRs through the NSX Manager web interface >> System >> Certificates >> CSRs >> Generate CSR or outside of NSX if a common manager and cluster certificate is desired.
  ...
  tag gid: 'V-NMGR-4X-000094'
  tag rid: 'SV-NMGR-4X-000094'
