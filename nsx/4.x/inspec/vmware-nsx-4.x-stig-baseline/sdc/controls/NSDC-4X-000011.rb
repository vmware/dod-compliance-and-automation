control 'NSDC-4X-000011' do
  title 'The NSX Controller must be configured as a cluster.'
  ...
  desc  'rationale', ''
  desc  'check', "
    From the NSX Manager web interface, go to System >> Appliances.
  ...
  desc 'fix', "
    ...
    From the NSX Manager web interface, go to System >>Appliances, and then click \"Add NSX Appliance\".
    ...
    From the NSX Manager web interface, go to System >> Appliances, and then click \"Set Virtual IP\", enter a VIP that is part of the same subnet as the other management nodes, and then click \"Save\".
  ...
  tag gid: 'V-NSDC-4X-000011'
  tag rid: 'SV-NSDC-4X-000011'
  tag stig_id: 'NSDC-4X-000011'
  tag cci: ['CCI-001665']
  tag nist: ['SC-24']
