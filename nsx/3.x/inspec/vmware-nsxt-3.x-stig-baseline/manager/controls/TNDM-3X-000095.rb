control 'TNDM-3X-000095' do
  ...
  desc  'rationale', ''
  desc  'check', "
    NSX-T Manager uses a certificate for each manager and one for the cluster VIP. In some cases these are the same, but each node and cluster VIP certificate must be checked individually.
  ...
  tag satisfies: ['SRG-APP-000175-NDM-000262']
  tag gid: 'V-251792'
  tag rid: 'SV-251792r810379_rule'
  tag stig_id: 'TNDM-3X-000095'
  tag fix_id: 'F-55206r810378_fix'
  tag cci: ['CCI-000366', 'CCI-000185']
  tag nist: ['CM-6 b', 'IA-5 (2) (a)']
