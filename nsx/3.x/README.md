# VMware NSX-T 3.x STIG Compliance and Automation

## Overview
*STIG Status: Official STIG*

[Visit public.cyber.mil for the latest official releases](https://public.cyber.mil/stigs/)

This project contains content for compliance auditing and remediation of the VMware NSX-T 3.x DoD STIG Baseline.

The VMware NSX-T 3.x Security Technical Implementation Guides (STIGs) provide security policy and configuration requirements for the use of NSX-T 3.x in the Department of Defense (DoD).
...
This repo for NSX-T 3.x is split up between auditing and remediation aspects with playbooks (Ansible) and profiles (InSpec).  
