# VMware NSX-T 3.x STIG Documentation
...
## Intended Audience
The audience for the VMware NSX-T 3.x STIG and/or STIG Readiness Guides is VMware NSX-T 3.x customers in the DOD needing to harden and accredit their vSphere environments. Other entities can use this guidance, however there are items that are specific to the DOD that will not be applicable to a non-DOD environment.
...
|:-----------------:|:------------------:|:------------------:|:------------------:|
|     `V1R1`        |    Official STIG   |     2022/03/30     |[U_VMW_NSX-T_V1R1_STIG.zip](U_VMW_NSX-T_V1R1_STIG.zip)|
|     `V1R2`        |    Official STIG   |     2022/09/02     |[U_VMW_NSX-T_V1R2_STIG.zip](U_VMW_NSX-T_V1R2_STIG.zip)|
|     `V1R3`        |    Official STIG   |     2023/07/26     |[U_VMW_NSX-T_Y23M07_STIG.zip](https://dl.dod.cyber.mil/wp-content/uploads/stigs/zip/U_VMW_NSX-T_Y23M07_STIG.zip)|
