control 'WOAD-3X-000133' do
  title 'The Workspace ONE Access vPostgres instance must produce error logs for SQL statements causing an error condition.'
  desc  "
  ...
  desc  'check', "
    ...
    # /opt/vmware/vpostgres/9.6/bin/psql -U postgres -A -t -c \"SHOW log_min_error_statement\"
  ...
  desc 'fix', "
    ...
    # /opt/vmware/vpostgres/9.6/bin/psql -U postgres -c \"ALTER SYSTEM SET log_min_error_statement TO 'error';\"
  ...
  tag gid: 'V-WOAD-3X-000133'
  tag rid: 'SV-WOAD-3X-000133'
  tag stig_id: 'WOAD-3X-000133'
  tag cci: ['CCI-000130']
  tag nist: ['AU-3']
  ...
  if clustered
    describe command('/opt/vmware/vpostgres/9.6/bin/psql -U postgres -A -t -c "SHOW log_min_error_statement;"') do
