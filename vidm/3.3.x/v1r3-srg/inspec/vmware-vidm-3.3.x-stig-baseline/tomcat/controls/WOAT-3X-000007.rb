control 'WOAT-3X-000007' do
  title 'Workspace ONE Access must record user access in a format that enables monitoring of remote access.'
  desc  "
  ...
  desc  'check', "
    ...
    # xmllint --xpath '/Server/Service/Engine/Host/Valve[@className=\"org.apache.catalina.valves.AccessLogValve\"]/@pattern' /opt/vmware/horizon/workspace/conf/server.xml

    Expected result:

    pattern=\"%h %l %u %t [%I] &quot;%r&quot; %s %b &quot;%{User-Agent}i&quot;\"
  ...
  desc 'fix', "
    ...
    Note: The existing entry may need to be uncommented too.
  "
  impact 0.5
  tag severity: 'medium'
  tag gtitle: 'SRG-APP-000016-WSR-000005'
  tag satisfies: ['SRG-APP-000095-WSR-000056', 'SRG-APP-000096-WSR-000057', 'SRG-APP-000097-WSR-000058', 'SRG-APP-000098-WSR-000059', 'SRG-APP-000098-WSR-000060', 'SRG-APP-000099-WSR-000061', 'SRG-APP-000100-WSR-000064', 'SRG-APP-000374-WSR-000172', 'SRG-APP-000375-WSR-000171']
  tag gid: 'V-WOAT-3X-000007'
  tag rid: 'SV-WOAT-3X-000007'
  tag stig_id: 'WOAT-3X-000007'
  tag cci: ['CCI-000067', 'CCI-000130', 'CCI-000131', 'CCI-000132', 'CCI-000133', 'CCI-000134', 'CCI-001487', 'CCI-001889', 'CCI-001890']
