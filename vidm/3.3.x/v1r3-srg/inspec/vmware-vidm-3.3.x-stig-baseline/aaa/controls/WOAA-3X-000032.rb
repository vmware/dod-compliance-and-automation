control 'WOAA-3X-000032' do
  title 'Workspace ONE Access must be configured to enforce password complexity by requiring that at least one upper-case character be used.'
  ...
  desc  'check', "
    ...
    If \"Uppercase characters\" is not set to at least \"1\", this is a finding.
  "
  desc 'fix', "
    Login to the Workspace ONE Access admin console at \"https://<hostname>/SAAS/admin\" using administrative credentials.
    ...
    Set \"Uppercase characters\" to \"1\" and click Save.
  "
  impact 0.5
  tag severity: 'medium'
  tag gtitle: 'SRG-APP-000166-AAA-000460'
  tag gid: 'V-WOAA-3X-000032'
  tag rid: 'SV-WOAA-3X-000032'
  tag stig_id: 'WOAA-3X-000032'
  tag cci: ['CCI-000192']
  tag nist: ['IA-5 (1) (a)']
