control 'NGNX-WB-000103' do
  title 'NGINX must prevent rendering inside a frame or iframe on another site.'
  desc  "
  ...
  tag gid: 'V-NGNX-WB-000103'
  tag rid: 'SV-NGNX-WB-000103'
  tag stig_id: 'NGNX-WB-000103'
  tag cci: ['CCI-000366']
  tag nist: ['CM-6 b']
