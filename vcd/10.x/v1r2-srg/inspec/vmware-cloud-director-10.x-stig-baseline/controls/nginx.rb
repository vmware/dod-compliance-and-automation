include_controls 'nginx' do
  ...
  # Currently VCD permissions for /etc/nginx are nginx:nginx and not root and will be addressed in a future version but cannot be changed currently.
  skip_control 'NGNX-WB-000078'
  # Certificates are covered in a VCD App control
