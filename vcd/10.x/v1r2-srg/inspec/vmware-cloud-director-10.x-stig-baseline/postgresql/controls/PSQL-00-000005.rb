control 'PSQL-00-000005' do
  ...
  tag gid: 'V-PSQL-00-000005'
  tag rid: 'SV-PSQL-00-000005'
  tag stig_id: 'PSQL-00-000005'
  tag cci: ['CCI-000169']
  tag nist: ['AU-12 a']

  sql_result = command("su - postgres -c '/opt/vmware/vpostgres/current/bin/psql -A -t -c \"SHOW shared_preload_libraries;\"'")

  describe "Shared Preload Libraries - '#{sql_result.stdout.strip}'" do
    subject { sql_result.stdout.strip }
    it { should match /pgaudit/ }
  end
end
