control 'PSQL-00-000075' do
  ...
  desc  'check', "
    ...
    # /usr/pgsql/13/bin/psql -h localhost -U postgres -A -t -c \"SHOW log_timezone\"
  ...
  desc 'fix', "
    ...
    # /usr/pgsql/13/bin/psql -h localhost -U postgres -c \"ALTER SYSTEM SET log_timezone TO 'UTC';\"
