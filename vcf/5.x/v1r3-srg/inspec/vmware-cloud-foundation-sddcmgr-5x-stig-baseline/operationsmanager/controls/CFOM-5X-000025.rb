control 'CFOM-5X-000025' do
  title 'The SDDC Manager Operations Manager service must protect log information from unauthorized access.'
  desc  "
  ...
  tag gid: 'V-CFOM-5X-000025'
  tag rid: 'SV-CFOM-5X-000025'
  tag stig_id: 'CFOM-5X-000025'
  tag cci: ['CCI-000162', 'CCI-000163', 'CCI-000164', 'CCI-001314']
  tag nist: ['AU-9', 'SI-11 b']

  describe command('find /var/log/vmware/vcf/operationsmanager -xdev -type f -a \'(\' -perm -o+w -o -not -user vcf_operationsmanager -o -not -group vcf \')\' -exec ls -ld {} \\;') do
