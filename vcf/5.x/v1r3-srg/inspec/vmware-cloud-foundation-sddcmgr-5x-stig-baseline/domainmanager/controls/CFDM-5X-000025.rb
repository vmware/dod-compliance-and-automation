control 'CFDM-5X-000025' do
  title 'The SDDC Manager Domain Manager service must protect log information from unauthorized access.'
  desc  "
  ...
  desc  'check', "
    ...
    # find /var/log/vmware/vcf/domainmanager/ -xdev -type f -a '(' -perm -o+w -o -not -user vcf_domainmanager -o -not -group vcf ')' -exec ls -ld {} \\;
  ...
  tag gid: 'V-CFDM-5X-000025'
  tag rid: 'SV-CFDM-5X-000025'
  tag stig_id: 'CFDM-5X-000025'
  tag cci: ['CCI-000162', 'CCI-000163', 'CCI-000164', 'CCI-001314']
  tag nist: ['AU-9', 'SI-11 b']

  describe command('find /var/log/vmware/vcf/domainmanager -xdev -type f -a \'(\' -perm -o+w -o -not -user vcf_domainmanager -o -not -group vcf \')\' -exec ls -ld {} \\;') do
