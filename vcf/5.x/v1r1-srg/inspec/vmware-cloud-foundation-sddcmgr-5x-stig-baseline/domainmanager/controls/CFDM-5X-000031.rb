control 'CFDM-5X-000031' do
  title 'The SDDC Manager Domain Manager service must offload logs to a centralized logging server.'
  ...
  tag gid: 'V-CFDM-5X-000031'
  tag rid: 'SV-CFDM-5X-000031'
  tag stig_id: 'CFDM-5X-000031'
