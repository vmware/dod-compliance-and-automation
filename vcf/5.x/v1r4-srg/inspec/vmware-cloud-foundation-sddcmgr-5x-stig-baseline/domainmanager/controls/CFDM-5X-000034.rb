control 'CFDM-5X-000034' do
  title 'The SDDC Manager Domain Manager service must limit privileges to change the software resident within software libraries.'
  ...
  tag gid: 'V-CFDM-5X-000034'
  tag rid: 'SV-CFDM-5X-000034'
  tag stig_id: 'CFDM-5X-000034'
  tag cci: ['CCI-001499']
  tag nist: ['CM-5 (6)']
