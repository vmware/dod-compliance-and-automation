control 'PSQL-00-000047' do
  ...
  desc  'check', "
    ...
    # /usr/pgsql/15/bin/psql -h localhost -U postgres -A -t -c \"SHOW tcp_keepalives_idle\"
    # /usr/pgsql/15/bin/psql -h localhost -U postgres -A -t -c \"SHOW tcp_keepalives_interval\"
    # /usr/pgsql/15/bin/psql -h localhost -U postgres -A -t -c \"SHOW tcp_keepalives_count\"
    # /usr/pgsql/15/bin/psql -h localhost -U postgres -A -t -c \"SHOW statement_timeout\"
  ...
  desc 'fix', "
    ...
    # /usr/pgsql/15/bin/psql -h localhost -U postgres -c \"ALTER SYSTEM SET statement_timeout = '1min';\"
    # /usr/pgsql/15/bin/psql -h localhost -U postgres -c \"ALTER SYSTEM SET tcp_keepalives_idle = '7200';\"
    # /usr/pgsql/15/bin/psql -h localhost -U postgres -c \"ALTER SYSTEM SET tcp_keepalives_interval = '75';\"
    # /usr/pgsql/15/bin/psql -h localhost -U postgres -c \"ALTER SYSTEM SET tcp_keepalives_count = '9';\"
  ...
  tag gid: 'V-PSQL-00-000047'
  tag rid: 'SV-PSQL-00-000047'
