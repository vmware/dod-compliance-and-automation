control 'CFNG-5X-000008' do
  title 'The SDDC Manager NGINX service must initiate session logging upon start up.'
  ...
  desc  'check', "
    ...
    If the \"error_log\" is not configured to log to \"/var/log/nginx/error.log\" with a level of \"info\", this is a finding.
  "
  desc 'fix', "
  ...
  tag gid: 'V-CFNG-5X-000008'
  tag rid: 'SV-CFNG-5X-000008'
  tag stig_id: 'CFNG-5X-000008'
  tag cci: ['CCI-001464']
  tag nist: ['AU-14 (1)']
