control 'CFNG-5X-000063' do
  title 'The SDDC Manager NGINX service must minimize the identity of the web server in information displayed to clients.'
  desc  "
  ...
  tag gid: 'V-CFNG-5X-000063'
  tag rid: 'SV-CFNG-5X-000063'
  tag stig_id: 'CFNG-5X-000063'
  tag cci: ['CCI-001312']
  tag nist: ['SI-11 a']
