control 'CFCS-5X-000025' do
  title 'The SDDC Manager Common Services service must protect log information from unauthorized access.'
  desc  "
  ...
  desc  'check', "
    ...
    # find /var/log/vmware/vcf/commonsvcs/ -xdev -type f -a '(' -perm -o+w -o -not -user vcf_commonsvcs -o -not -group vcf ')' -exec ls -ld {} \\;
  ...
  tag gid: 'V-CFCS-5X-000025'
  tag rid: 'SV-CFCS-5X-000025'
  tag stig_id: 'CFCS-5X-000025'
  tag cci: ['CCI-000162', 'CCI-000163', 'CCI-000164', 'CCI-001314']
  tag nist: ['AU-9 a', 'SI-11 b']

  describe command('find /var/log/vmware/vcf/commonsvcs -xdev -type f -a \'(\' -perm -o+w -o -not -user vcf_commonsvcs -o -not -group vcf \')\' -exec ls -ld {} \\;') do
