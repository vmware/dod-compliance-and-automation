control 'CFCS-5X-000031' do
  title 'The SDDC Manager Common Services service must offload logs to a centralized logging server.'
  ...
  tag gid: 'V-CFCS-5X-000031'
  tag rid: 'SV-CFCS-5X-000031'
  tag stig_id: 'CFCS-5X-000031'
