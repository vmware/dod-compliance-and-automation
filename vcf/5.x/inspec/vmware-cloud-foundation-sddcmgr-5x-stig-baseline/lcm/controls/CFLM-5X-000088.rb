control 'CFLM-5X-000088' do
  title 'The SDDC Manager LCM service must restrict changes to application server configuration.'
  desc  "
  ...
  desc  'check', "
    ...
    # find /opt/vmware/vcf/lcm/lcm-app/conf -xdev -type f -a '(' -perm /177 -o -not -user vcf_lcm -o -not -group vcf ')' -exec ls -ld {} \\;
  ...
  tag gid: 'V-CFLM-5X-000088'
  tag rid: 'SV-CFLM-5X-000088'
  tag stig_id: 'CFLM-5X-000088'
  tag cci: ['CCI-001493', 'CCI-001494', 'CCI-001495', 'CCI-001813', 'CCI-002235']
  tag nist: ['AC-6 (10)', 'AU-9', 'CM-5 (1)']

  command('find /opt/vmware/vcf/lcm/lcm-app/conf -xdev -type f').stdout.split.each do |fname|
    describe file(fname) do
      it { should_not be_more_permissive_than('0600') }
      its('owner') { should cmp 'vcf_lcm' }
