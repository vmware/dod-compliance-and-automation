control 'CFNG-5X-000004' do
  ...
  desc  'check', "
    ...
    If the \"Strict-Transport-Security\" header is not configured, this is a finding.
  "
  desc 'fix', "
  ...
  tag gid: 'V-CFNG-5X-000004'
  tag rid: 'SV-CFNG-5X-000004'
  tag stig_id: 'CFNG-5X-000004'
  tag cci: ['CCI-001453']
  tag nist: ['AC-17 (2)']
