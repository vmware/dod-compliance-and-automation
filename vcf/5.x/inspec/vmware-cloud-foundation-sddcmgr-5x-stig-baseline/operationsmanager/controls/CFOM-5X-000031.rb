control 'CFOM-5X-000031' do
  title 'The SDDC Manager Operations Manager service must offload logs to a centralized logging server.'
  ...
  desc  'check', "
    ...
    input(type=\"imfile\"
          ...
          Facility=\"local0\")
    input(type=\"imfile\"
          File=\"/var/log/vmware/vcf/operationsmanager/operationsmanager.out\"
          Tag=\"vcf-operationsmanager-out\"
          Severity=\"info\"
          Facility=\"local0\")
  ...
  tag gid: 'V-CFOM-5X-000031'
  tag rid: 'SV-CFOM-5X-000031'
  tag stig_id: 'CFOM-5X-000031'
