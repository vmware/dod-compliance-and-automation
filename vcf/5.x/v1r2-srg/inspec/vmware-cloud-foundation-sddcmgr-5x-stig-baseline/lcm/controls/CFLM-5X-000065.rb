control 'CFLM-5X-000065' do
  title 'The SDDC Manager LCM service must check the validity of all data inputs.'
  desc  "
  ...
  tag gid: 'V-CFLM-5X-000065'
  tag rid: 'SV-CFLM-5X-000065'
  tag stig_id: 'CFLM-5X-000065'
  tag cci: ['CCI-001310']
  tag nist: ['SI-10']
