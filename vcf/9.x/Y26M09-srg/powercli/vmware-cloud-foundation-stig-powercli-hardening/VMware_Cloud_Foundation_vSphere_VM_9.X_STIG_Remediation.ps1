<# 
  ...
  .NOTES 
    File Name  : VMware_Cloud_Foundation_vSphere_VM_9.X_STIG_Remediation.ps1 
    Author     : Broadcom
    Version    : 1.0.0
    License    : Apache-2.0
  ...
  .EXAMPLE
  PS> .\VMware_Cloud_Foundation_vSphere_VM_9.X_STIG_Remediation.ps1 -vccred $vccred

  .EXAMPLE
  PS> .\VMware_Cloud_Foundation_vSphere_VM_9.X_STIG_Remediation.ps1 -vccred $vccred -NoSafetyChecks

  .EXAMPLE
  PS> .\VMware_Cloud_Foundation_vSphere_VM_9.X_STIG_Remediation.ps1 -vccred $vccred -NoSafetyChecks -RevertToDefault
...
param (
  ...
  [string]$RemediationVarsFile = "VMware_Cloud_Foundation_vSphere_VM_9.X_STIG_Remediation_Variables.ps1"
)
