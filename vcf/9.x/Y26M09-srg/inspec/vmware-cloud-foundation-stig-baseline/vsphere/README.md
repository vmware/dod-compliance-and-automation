...
VMware Cloud Foundation vSphere 9.x STIG Readiness Guide Chef InSpec Profile    
...
## Requirements
- [Chef InSpec](https://downloads.chef.io/tools/inspec) or [CINC Auditor](https://cinc.sh/start/auditor/) installed on a machine that has PowerCLI 13+ installed. Tested with version 7.0.107-1. Chef/CINC Workstation can also be installed and used.  
