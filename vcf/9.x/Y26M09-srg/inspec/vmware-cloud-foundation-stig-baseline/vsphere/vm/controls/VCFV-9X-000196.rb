control 'VCFV-9X-000196' do
  ...
  desc  'check', "
    ...
    If the virtual machine advanced setting \"isolation.tools.dnd.disable\" exists and is not set to \"true\", this is a finding.
  ...
  tag gid: 'V-VCFV-9X-000196'
  tag rid: 'SV-VCFV-9X-000196'
  tag stig_id: 'VCFV-9X-000196'
  tag cci: ['CCI-000366']
  tag nist: ['CM-6 b']
  ...
  vms = []
  advSettingName = 'isolation.tools.dnd.disable'
