control 'VCFV-9X-000197' do
  ...
  desc  'check', "
    ...
    If the virtual machine advanced setting \"isolation.tools.paste.disable\" exists and is not set to \"true\", this is a finding.
  ...
  tag gid: 'V-VCFV-9X-000197'
  tag rid: 'SV-VCFV-9X-000197'
  tag stig_id: 'VCFV-9X-000197'
  tag cci: ['CCI-000366']
  tag nist: ['CM-6 b']
  ...
  vms = []
  advSettingName = 'isolation.tools.paste.disable'
