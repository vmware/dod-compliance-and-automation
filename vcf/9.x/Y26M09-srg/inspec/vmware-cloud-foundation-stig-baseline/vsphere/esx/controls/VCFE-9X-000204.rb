control 'VCFE-9X-000204' do
  ...
  if vmhosts.nil? || vmhosts.empty?
    ...
    vmhosts.each do |vmhost|
      ...
      iscsi_empty = iscsi_hbas.nil? || iscsi_hbas.strip.empty?
      vsan_empty = vsanvmks.nil? || vsanvmks.strip.empty?
      nfs_empty = nfsds.nil? || nfsds.strip.empty?

      if iscsi_empty && vsan_empty && nfs_empty
        describe '' do
