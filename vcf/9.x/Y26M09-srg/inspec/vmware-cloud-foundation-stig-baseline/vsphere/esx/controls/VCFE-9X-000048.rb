control 'VCFE-9X-000048' do
  ...
  tag satisfies: ['SRG-OS-000109-VMM-000550', 'SRG-OS-000123-VMM-000620', 'SRG-OS-000835-VMM-000280']
  tag gid: 'V-VCFE-9X-000048'
  tag rid: 'SV-VCFE-9X-000048'
  tag stig_id: 'VCFE-9X-000048'
  tag cci: ['CCI-000764', 'CCI-001682', 'CCI-003650', 'CCI-004045']
  tag nist: ['AC-2 (2)', 'AC-3 (13)', 'IA-2', 'IA-2 (5)']
  ...
  unless vmhostName.nil? || vmhostName.empty?
    vmhosts = powercli_command("Get-VMHost -Name #{vmhostName} | Sort-Object Name | Select -ExpandProperty Name").stdout.gsub("\r\n", "\n").split("\n")
  end
  unless cluster.nil? || cluster.empty?
