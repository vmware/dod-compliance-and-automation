control 'VCFA-9X-000333' do
  ...
  if currentUsers.nil? || currentUsers.empty?
    ...
    unless applmgmtuser.nil? || applmgmtuser.empty?
    ...
    unless svcsddcuser.nil? || svcsddcuser.empty?
  ...
  if currentGroups.nil? || currentGroups.empty?
