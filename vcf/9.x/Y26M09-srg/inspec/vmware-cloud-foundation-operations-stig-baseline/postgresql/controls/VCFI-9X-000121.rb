control 'VCFI-9X-000121' do
  title 'The VMware Cloud Foundation Operations PostgreSQL service must off-load audit data to a separate log management facility.'
  desc  "
  ...
  desc  'check', "
    ...
    input(type=\"imfile\"
          File=\"/storage/log/postgres/repl/*.log\"
  ...
  tag gid: 'V-VCFI-9X-000121'
  tag rid: 'SV-VCFI-9X-000121'
  tag stig_id: 'VCFI-9X-000121'
