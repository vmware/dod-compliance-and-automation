control 'VCFL-9X-000020' do
  title 'The VMware Cloud Foundation vCenter PostgreSQL service must be configured to protect log files from unauthorized access.'
  desc  "
  ...
  tag gid: 'V-VCFL-9X-000020'
  tag rid: 'SV-VCFL-9X-000020'
  tag stig_id: 'VCFL-9X-000020'
