control 'VCFB-9X-000104' do
  title 'The VMware Cloud Foundation SDDC Manager NGINX server must protect against MIME sniffing.'
  desc  "
  ...
  desc  'check', "
    ...
    If the \"X-Content-Type-Options\" header is not configured to \"nosniff\", this is a finding.
  ...
  tag gid: 'V-VCFB-9X-000104'
  tag rid: 'SV-VCFB-9X-000104'
  tag stig_id: 'VCFB-9X-000104'
  tag cci: ['CCI-000366']
  tag nist: ['CM-6 b']
