control 'VCFC-9X-000009' do
  ...
  desc  'check', "
    ...
    # /usr/pgsql/16/bin/psql -h localhost -U postgres -A -t -c \"SHOW log_destination;\"
  ...
  desc 'fix', "
    ...
    # /usr/pgsql/16/bin/psql -h localhost -U postgres -c \"ALTER SYSTEM SET log_destination = 'stderr';\"
