control 'VCFO-9X-000062' do
  title 'The VMware Cloud Foundation Operations for Networks Platform NGINX server must disable directory listings.'
  desc  "
  ...
  tag gid: 'V-VCFO-9X-000062'
  tag rid: 'SV-VCFO-9X-000062'
  tag stig_id: 'VCFO-9X-000062'
  tag cci: ['CCI-001312']
  tag nist: ['SI-11 a']
