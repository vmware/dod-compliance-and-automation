control 'VCFO-9X-000047' do
  title 'The VMware Cloud Foundation Operations for Networks Platform NGINX server must invalidate session identifiers upon hosted application user logout or other session termination.'
  desc  "
  ...
  desc  'check', "
    ...
    # nginx -T 2>&1 | grep ssl_session_timeout
  ...
  tag gid: 'V-VCFO-9X-000047'
  tag rid: 'SV-VCFO-9X-000047'
  tag stig_id: 'VCFO-9X-000047'
