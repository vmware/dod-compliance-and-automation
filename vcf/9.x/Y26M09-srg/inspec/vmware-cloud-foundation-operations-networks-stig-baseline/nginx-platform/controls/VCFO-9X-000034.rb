control 'VCFO-9X-000034' do
  title 'The VMware Cloud Foundation Operations for Networks Platform NGINX server must have Web Distributed Authoring (WebDAV) disabled.'
  desc  "
  ...
  tag gid: 'V-VCFO-9X-000034'
  tag rid: 'SV-VCFO-9X-000034'
  tag stig_id: 'VCFO-9X-000034'
  tag cci: ['CCI-000381']
  tag nist: ['CM-7 a']
  ...
  if staticmodules.nil? || staticmodules.empty?
  ...
  unless dynamicmodules.nil? || dynamicmodules.empty?
