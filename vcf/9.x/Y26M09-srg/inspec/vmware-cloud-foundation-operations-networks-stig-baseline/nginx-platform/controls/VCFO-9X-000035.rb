control 'VCFO-9X-000035' do
  title 'The VMware Cloud Foundation Operations for Networks Platform NGINX server worker process must be run as a nonprivileged user.'
  ...
  tag gid: 'V-VCFO-9X-000035'
  tag rid: 'SV-VCFO-9X-000035'
  tag stig_id: 'VCFO-9X-000035'
  tag cci: ['CCI-000381']
  tag nist: ['CM-7 a']
