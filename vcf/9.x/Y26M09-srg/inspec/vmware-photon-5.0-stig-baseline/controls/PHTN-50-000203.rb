control 'PHTN-50-000203' do
  ...
  desc  'check', "
    ...
    If \"ClientAliveCountMax\" is not set to \"0\" or \"1\", this is a finding.
  "
  desc 'fix', "
  ...
  describe command("#{sshdcommand}|&grep -i ClientAliveCountMax | cut -d' ' -f2") do
    its('stdout.strip') { should be_in ['0', '1'] }
  end
end
