control 'VCFJ-9X-000001' do
  title 'The VMware Cloud Foundation Operations HCX Apache HTTP service must limit the number of allowed simultaneous session requests.'
  desc  "
  ...
  desc  'check', "
    ...
    # grep -i \"KeepAlive\" /etc/httpd/conf/httpd.conf /opt/vmware/config/apache-httpd/hcx-ssl.conf /opt/vmware/config/apache-httpd/hcx-virtual-hosts.conf
  ...
  tag gid: 'V-VCFJ-9X-000001'
  tag rid: 'SV-VCFJ-9X-000001'
  tag stig_id: 'VCFJ-9X-000001'
  tag cci: ['CCI-000054']
  tag nist: ['AC-10']
