control 'VCFJ-9X-000018' do
  title 'The VMware Cloud Foundation Operations HCX Apache HTTP service log files must only be accessible by privileged users.'
  desc  "
  ...
  desc  'check', "
    ...
    # find /common/logs/httpd/ -type f -exec stat -c \"%n is owned by %U and group %G permissions are %a\" {} $1\\;
  ...
  tag gid: 'V-VCFJ-9X-000018'
  tag rid: 'SV-VCFJ-9X-000018'
  tag stig_id: 'VCFJ-9X-000018'
