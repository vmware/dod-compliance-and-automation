control 'VCFJ-9X-000024' do
  title 'The VMware Cloud Foundation Operations HCX Apache HTTP service must not perform user management for hosted applications.'
  desc  "
  ...
  desc  'check', "
    ...
    # grep -i \"AuthUserFile\" /etc/httpd/conf/httpd.conf /opt/vmware/config/apache-httpd/hcx-ssl.conf /opt/vmware/config/apache-httpd/hcx-virtual-hosts.conf
  ...
  tag gid: 'V-VCFJ-9X-000024'
  tag rid: 'SV-VCFJ-9X-000024'
  tag stig_id: 'VCFJ-9X-000024'
  tag cci: ['CCI-000381']
  tag nist: ['CM-7 a']
