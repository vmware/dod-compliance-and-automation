control 'VCFQ-9X-000090' do
  title 'The VMware Cloud Foundation Operations Fleet Management NGINX server must maintain the confidentiality of controlled information during transmission through the use of an approved TLS version.'
  desc  "
  ...
  tag gid: 'V-VCFQ-9X-000090'
  tag rid: 'SV-VCFQ-9X-000090'
  tag stig_id: 'VCFQ-9X-000090'
