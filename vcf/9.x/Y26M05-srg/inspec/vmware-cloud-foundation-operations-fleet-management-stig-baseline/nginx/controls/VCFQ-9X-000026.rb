control 'VCFQ-9X-000026' do
  title 'The VMware Cloud Foundation Operations Fleet Management NGINX server must only contain modules necessary for operation.'
  desc  "
  ...
  desc  'check', "
    ...
    The following modules are shipped with the Fleet Management appliance and can be considered the approved baseline:
  ...
  tag gid: 'V-VCFQ-9X-000026'
  tag rid: 'SV-VCFQ-9X-000026'
  tag stig_id: 'VCFQ-9X-000026'
  tag cci: ['CCI-000381']
  tag nist: ['CM-7 a']
