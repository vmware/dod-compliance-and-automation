control 'VCFQ-9X-000111' do
  title 'The VMware Cloud Foundation Operations Fleet Management NGINX server must enable HTTP/2. '
  desc  "
  ...
  tag gid: 'V-VCFQ-9X-000111'
  tag rid: 'SV-VCFQ-9X-000111'
  tag stig_id: 'VCFQ-9X-000111'
