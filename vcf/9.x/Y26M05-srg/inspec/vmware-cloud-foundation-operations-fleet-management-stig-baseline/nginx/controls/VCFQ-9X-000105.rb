control 'VCFQ-9X-000105' do
  title 'The VMware Cloud Foundation Operations Fleet Management NGINX server must enable Content Security Policy.'
  ...
  tag gid: 'V-VCFQ-9X-000105'
  tag rid: 'SV-VCFQ-9X-000105'
  tag stig_id: 'VCFQ-9X-000105'
  tag cci: ['CCI-000366']
  tag nist: ['CM-6 b']
