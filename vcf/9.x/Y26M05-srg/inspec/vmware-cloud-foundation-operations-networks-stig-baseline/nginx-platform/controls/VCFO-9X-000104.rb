control 'VCFO-9X-000104' do
  title 'The VMware Cloud Foundation Operations for Networks Platform NGINX server must protect against MIME sniffing.'
  desc  "
  ...
  tag gid: 'V-VCFO-9X-000104'
  tag rid: 'SV-VCFO-9X-000104'
  tag stig_id: 'VCFO-9X-000104'
  tag cci: ['CCI-000366']
  tag nist: ['CM-6 b']
