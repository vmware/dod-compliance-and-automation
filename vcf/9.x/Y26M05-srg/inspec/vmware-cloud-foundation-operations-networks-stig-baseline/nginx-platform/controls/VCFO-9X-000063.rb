control 'VCFO-9X-000063' do
  title 'The VMware Cloud Foundation Operations for Networks Platform NGINX server must minimize the identity of the web server in information displayed to clients.'
  desc  "
  ...
  tag gid: 'V-VCFO-9X-000063'
  tag rid: 'SV-VCFO-9X-000063'
  tag stig_id: 'VCFO-9X-000063'
  tag cci: ['CCI-001312']
  tag nist: ['SI-11 a']
