control 'VCFI-9X-000005' do
  title 'The VMware Cloud Foundation Operations PostgreSQL service must enable "pgaudit" to provide audit record generation capabilities.'
  desc  "
  ...
  desc 'fix', "
    ...
    /storage/db/vcops/vpostgres/repl/postgresql.conf
  ...
  tag gid: 'V-VCFI-9X-000005'
  tag rid: 'SV-VCFI-9X-000005'
  tag stig_id: 'VCFI-9X-000005'
  tag cci: ['CCI-000169']
  tag nist: ['AU-12 a']
