control 'VCFO-9X-000106' do
  ...
  desc 'fix', "
    ...
    Add or update the \"add_header Referrer-Policy\" directive for each of the server contexts, for example:
  ...
  tag gid: 'V-VCFO-9X-000106'
  tag rid: 'SV-VCFO-9X-000106'
  tag stig_id: 'VCFO-9X-000106'
  tag cci: ['CCI-000366']
  tag nist: ['CM-6 b']
