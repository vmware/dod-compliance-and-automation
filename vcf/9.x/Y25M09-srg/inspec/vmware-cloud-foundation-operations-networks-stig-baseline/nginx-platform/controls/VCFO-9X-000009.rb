control 'VCFO-9X-000009' do
  title 'The VMware Cloud Foundation Operations for Networks Platform NGINX server must capture, record, and log all content related to a user session.'
  desc  "
  ...
  tag gid: 'V-VCFO-9X-000009'
  tag rid: 'SV-VCFO-9X-000009'
  tag stig_id: 'VCFO-9X-000009'
  tag cci: ['CCI-001462']
  tag nist: ['AU-14 (2)']
