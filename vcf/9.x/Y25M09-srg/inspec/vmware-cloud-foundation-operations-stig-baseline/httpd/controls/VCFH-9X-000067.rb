control 'VCFH-9X-000067' do
  ...
  desc  'check', "
    ...
    # grep -i \"TraceEnable\" /etc/httpd/conf/httpd.conf /etc/httpd/conf/extra/httpd-ssl.conf /usr/lib/vmware-vcopssuite/utilities/conf/vcops-apache.conf
  ...
  tag gid: 'V-VCFH-9X-000067'
  tag rid: 'SV-VCFH-9X-000067'
  tag stig_id: 'VCFH-9X-000067'
  tag cci: ['CCI-001312']
  tag nist: ['SI-11 a']
