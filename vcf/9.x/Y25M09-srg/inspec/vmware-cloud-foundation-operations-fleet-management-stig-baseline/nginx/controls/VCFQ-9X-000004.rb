control 'VCFQ-9X-000004' do
  title 'The VMware Cloud Foundation Operations Fleet Management NGINX server must implement HTTP Strict Transport Security (HSTS) to protect the integrity of remote sessions of external server contexts.'
  ...
  tag gid: 'V-VCFQ-9X-000004'
  tag rid: 'SV-VCFQ-9X-000004'
  tag stig_id: 'VCFQ-9X-000004'
  tag cci: ['CCI-001453']
  tag nist: ['AC-17 (2)']
