control 'VCFQ-9X-000025' do
  title 'The VMware Cloud Foundation Operations Fleet Management NGINX server must not perform user management for hosted applications.'
  desc  "
  ...
  tag gid: 'V-VCFQ-9X-000025'
  tag rid: 'SV-VCFQ-9X-000025'
  tag stig_id: 'VCFQ-9X-000025'
  tag cci: ['CCI-000381']
  tag nist: ['CM-7 a']
