control 'VCFQ-9X-000106' do
  title 'The VMware Cloud Foundation Operations Fleet Management NGINX server must configure the Referrer-Policy header.'
  ...
  tag gid: 'V-VCFQ-9X-000106'
  tag rid: 'SV-VCFQ-9X-000106'
  tag stig_id: 'VCFQ-9X-000106'
  tag cci: ['CCI-000366']
  tag nist: ['CM-6 b']
