control 'VCFQ-9X-000102' do
  title 'The VMware Cloud Foundation Operations Fleet Management NGINX server must disable SSL session tickets.'
  ...
  tag gid: 'V-VCFQ-9X-000102'
  tag rid: 'SV-VCFQ-9X-000102'
  tag stig_id: 'VCFQ-9X-000102'
  tag cci: ['CCI-000366']
  tag nist: ['CM-6 b']
