control 'VCFQ-9X-000019' do
  title 'The VMware Cloud Foundation Operations Fleet Management NGINX server log files must only be accessible by privileged users.'
  desc  "
  ...
  desc  'check', "
    ...
    If any NGINX log file is not owned by root or an authorized user, this is a finding.

    If any NGINX log file is not group owned by root or an authorized user, this is a finding.
  ...
  tag gid: 'V-VCFQ-9X-000019'
  tag rid: 'SV-VCFQ-9X-000019'
  tag stig_id: 'VCFQ-9X-000019'
