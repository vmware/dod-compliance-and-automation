control 'VCFQ-9X-000103' do
  title 'The VMware Cloud Foundation Operations Fleet Management NGINX server must prevent rendering inside a frame or iframe on another site.'
  desc  "
  ...
  tag gid: 'V-VCFQ-9X-000103'
  tag rid: 'SV-VCFQ-9X-000103'
  tag stig_id: 'VCFQ-9X-000103'
  tag cci: ['CCI-000366']
  tag nist: ['CM-6 b']
