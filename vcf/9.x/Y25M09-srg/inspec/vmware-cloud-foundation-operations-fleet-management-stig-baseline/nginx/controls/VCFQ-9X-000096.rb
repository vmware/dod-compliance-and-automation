control 'VCFQ-9X-000096' do
  title 'The VMware Cloud Foundation Operations Fleet Management NGINX server must remove the default web site configuration.'
  ...
  tag gid: 'V-VCFQ-9X-000096'
  tag rid: 'SV-VCFQ-9X-000096'
  tag stig_id: 'VCFQ-9X-000096'
  tag cci: ['CCI-000366']
  tag nist: ['CM-6 b']
