control 'VCFC-9X-000010' do
  title 'The VMware Cloud Foundation SDDC Manager PostgreSQL service must produce logs containing sufficient information to establish what type of events occurred.'
  desc  "
  ...
  tag gid: 'V-VCFC-9X-000010'
  tag rid: 'SV-VCFC-9X-000010'
  tag stig_id: 'VCFC-9X-000010'
