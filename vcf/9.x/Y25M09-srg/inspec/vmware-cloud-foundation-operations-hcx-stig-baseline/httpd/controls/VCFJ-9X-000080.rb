control 'VCFJ-9X-000080' do
  title 'The VMware Cloud Foundation Operations HCX Apache HTTP service configuration files must only be accessible to privileged users.'
  desc  "
  ...
  tag gid: 'V-VCFJ-9X-000080'
  tag rid: 'SV-VCFJ-9X-000080'
  tag stig_id: 'VCFJ-9X-000080'
