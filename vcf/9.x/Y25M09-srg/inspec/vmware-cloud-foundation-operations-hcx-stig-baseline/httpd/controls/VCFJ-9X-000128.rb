control 'VCFJ-9X-000128' do
  title 'The VMware Cloud Foundation Operations HCX Apache HTTP service must configure the Referrer-Policy header.'
  ...
  tag gid: 'V-VCFJ-9X-000128'
  tag rid: 'SV-VCFJ-9X-000128'
  tag stig_id: 'VCFJ-9X-000128'
  tag cci: ['CCI-000366']
  tag nist: ['CM-6 b']
