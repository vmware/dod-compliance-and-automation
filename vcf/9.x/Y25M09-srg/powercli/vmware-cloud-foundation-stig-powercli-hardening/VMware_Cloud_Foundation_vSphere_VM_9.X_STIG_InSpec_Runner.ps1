<# 
  ...
  .NOTES 
    File Name  : VMware_Cloud_Foundation_vSphere_VM_9.X_STIG_InSpec_Runner.ps1 
    Author     : Broadcom
    Version    : 1.0.0
    License    : Apache-2.0
  ...
  .EXAMPLE
  PS> ./VMware_Cloud_Foundation_vSphere_VM_9.X_STIG_InSpec_Runner -vccred $vccred -NoSafetyChecks -InspecPath /usr/share/stigs/vmware-cloud-foundation-stig-baseline/vsphere/vm/ -InspecInputsFile /usr/share/stigs/vmware-cloud-foundation-stig-baseline/vsphere/inputs-example.yml
...
$ReportNamePrefix = "VMware_Cloud_Foundation_vSphere_VM_9.X_STIG_Remediation"
