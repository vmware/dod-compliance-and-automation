control 'VCFQ-9X-000098' do
  title 'The VMware Cloud Foundation Operations Fleet Management NGINX server must prefer server ciphers over client ciphers when using SSL/TLS.'
  ...
  desc 'fix', "
    ...
    Add the ssl_prefer_server_ciphers option to the http context, for example:
  ...
  tag gid: 'V-VCFQ-9X-000098'
  tag rid: 'SV-VCFQ-9X-000098'
  tag stig_id: 'VCFQ-9X-000098'
  tag cci: ['CCI-002418']
  tag nist: ['SC-8']
