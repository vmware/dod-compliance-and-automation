control 'VCFQ-9X-000001' do
  title 'The VMware Cloud Foundation Operations Fleet Management NGINX server must limit the number of concurrent connections per server.'
  desc  "
  ...
  tag gid: 'V-VCFQ-9X-000001'
  tag rid: 'SV-VCFQ-9X-000001'
  tag stig_id: 'VCFQ-9X-000001'
  tag cci: ['CCI-000054']
  tag nist: ['AC-10']
