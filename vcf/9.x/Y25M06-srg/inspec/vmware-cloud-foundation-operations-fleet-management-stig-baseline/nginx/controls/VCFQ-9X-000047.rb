control 'VCFQ-9X-000047' do
  title 'The VMware Cloud Foundation Operations Fleet Management NGINX server must invalidate session identifiers upon hosted application user logout or other session termination.'
  desc  "
  ...
  tag gid: 'V-VCFQ-9X-000047'
  tag rid: 'SV-VCFQ-9X-000047'
  tag stig_id: 'VCFQ-9X-000047'
