control 'VCFQ-9X-000104' do
  title 'The VMware Cloud Foundation Operations Fleet Management NGINX server must protect against MIME sniffing.'
  desc  "
  ...
  tag gid: 'V-VCFQ-9X-000104'
  tag rid: 'SV-VCFQ-9X-000104'
  tag stig_id: 'VCFQ-9X-000104'
  tag cci: ['CCI-000366']
  tag nist: ['CM-6 b']
