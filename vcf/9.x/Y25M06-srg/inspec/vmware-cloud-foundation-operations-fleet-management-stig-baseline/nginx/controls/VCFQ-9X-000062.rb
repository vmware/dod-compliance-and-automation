control 'VCFQ-9X-000062' do
  title 'The VMware Cloud Foundation Operations Fleet Management NGINX server must disable directory listings.'
  desc  "
  ...
  tag gid: 'V-VCFQ-9X-000062'
  tag rid: 'SV-VCFQ-9X-000062'
  tag stig_id: 'VCFQ-9X-000062'
  tag cci: ['CCI-001312']
  tag nist: ['SI-11 a']
