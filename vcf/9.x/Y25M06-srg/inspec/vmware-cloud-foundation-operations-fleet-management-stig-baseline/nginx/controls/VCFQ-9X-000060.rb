control 'VCFQ-9X-000060' do
  title 'The VMware Cloud Foundation Operations Fleet Management NGINX server must restrict the ability of users to launch Denial of Service (DoS) attacks against other information systems or networks.'
  ...
  tag gid: 'V-VCFQ-9X-000060'
  tag rid: 'SV-VCFQ-9X-000060'
  tag stig_id: 'VCFQ-9X-000060'
