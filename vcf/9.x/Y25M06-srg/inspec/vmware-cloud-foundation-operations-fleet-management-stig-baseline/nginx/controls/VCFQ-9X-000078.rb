control 'VCFQ-9X-000078' do
  title 'The VMware Cloud Foundation Operations Fleet Management NGINX server configuration files must only be accessible to privileged users.'
  desc  "
  ...
  tag gid: 'V-VCFQ-9X-000078'
  tag rid: 'SV-VCFQ-9X-000078'
  tag stig_id: 'VCFQ-9X-000078'
