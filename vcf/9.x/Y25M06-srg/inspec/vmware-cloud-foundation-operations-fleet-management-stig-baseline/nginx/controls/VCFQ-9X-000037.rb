control 'VCFQ-9X-000037' do
  title 'The VMware Cloud Foundation Operations Fleet Management NGINX server must be configured to use a specified IP address and port.'
  desc  "
  ...
  tag gid: 'V-VCFQ-9X-000037'
  tag rid: 'SV-VCFQ-9X-000037'
  tag stig_id: 'VCFQ-9X-000037'
