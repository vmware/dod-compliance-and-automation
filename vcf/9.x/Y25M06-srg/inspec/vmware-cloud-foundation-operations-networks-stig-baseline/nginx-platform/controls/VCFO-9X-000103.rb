control 'VCFO-9X-000103' do
  title 'The VMware Cloud Foundation Operations for Networks Platform NGINX server must prevent rendering inside a frame or iframe on another site.'
  desc  "
  ...
  desc  'check', "
    ...
    If a header is not configured as shown in the example in the http, server, or location context, this is a finding.
  ...
  desc 'fix', "
    ...
    Add an add_header directive in the http context, for example:
  ...
  tag gid: 'V-VCFO-9X-000103'
  tag rid: 'SV-VCFO-9X-000103'
  tag stig_id: 'VCFO-9X-000103'
  tag cci: ['CCI-000366']
  tag nist: ['CM-6 b']
