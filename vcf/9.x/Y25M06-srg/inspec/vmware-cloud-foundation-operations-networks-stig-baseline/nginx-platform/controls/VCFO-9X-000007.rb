control 'VCFO-9X-000007' do
  title 'The VMware Cloud Foundation Operations for Networks Platform NGINX server must generate log records for system events.'
  desc  "
  ...
  tag gid: 'V-VCFO-9X-000007'
  tag rid: 'SV-VCFO-9X-000007'
  tag stig_id: 'VCFO-9X-000007'
