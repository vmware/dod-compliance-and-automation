control 'VCFO-9X-000099' do
  title 'The VMware Cloud Foundation Operations for Networks Platform NGINX server must disable server side includes.'
  ...
  tag gid: 'V-VCFO-9X-000099'
  tag rid: 'SV-VCFO-9X-000099'
  tag stig_id: 'VCFO-9X-000099'
  tag cci: ['CCI-000366']
  tag nist: ['CM-6 b']
