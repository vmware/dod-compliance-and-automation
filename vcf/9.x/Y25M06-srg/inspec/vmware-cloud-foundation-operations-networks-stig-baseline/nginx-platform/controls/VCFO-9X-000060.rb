control 'VCFO-9X-000060' do
  title 'The VMware Cloud Foundation Operations for Networks Platform NGINX server must restrict the ability of users to launch Denial of Service (DoS) attacks against other information systems or networks.'
  ...
  tag gid: 'V-VCFO-9X-000060'
  tag rid: 'SV-VCFO-9X-000060'
  tag stig_id: 'VCFO-9X-000060'
