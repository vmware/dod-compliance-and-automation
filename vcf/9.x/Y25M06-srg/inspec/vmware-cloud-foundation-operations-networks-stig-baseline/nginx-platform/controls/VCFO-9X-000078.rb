control 'VCFO-9X-000078' do
  title 'The VMware Cloud Foundation Operations for Networks Platform NGINX server configuration files must only be accessible to privileged users.'
  desc  "
  ...
  tag gid: 'V-VCFO-9X-000078'
  tag rid: 'SV-VCFO-9X-000078'
  tag stig_id: 'VCFO-9X-000078'
