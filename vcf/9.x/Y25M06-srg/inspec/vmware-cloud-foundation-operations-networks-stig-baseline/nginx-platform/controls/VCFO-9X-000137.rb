control 'VCFO-9X-000137' do
  title 'The VMware Cloud Foundation Operations for Networks Platform NGINX server must limit the number of concurrent connections per IP.'
  desc  "
  ...
  tag gid: 'V-VCFO-9X-000137'
  tag rid: 'SV-VCFO-9X-000137'
  tag stig_id: 'VCFO-9X-000137'
  tag cci: ['CCI-000054']
  tag nist: ['AC-10']
