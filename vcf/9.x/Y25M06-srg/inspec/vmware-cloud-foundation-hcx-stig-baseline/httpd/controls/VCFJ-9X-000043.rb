control 'VCFJ-9X-000043' do
  title 'The VMware Cloud Foundation Operations HCX Apache HTTP service directory tree must only be accessible by authorized accounts.'
  ...
  desc  'check', "
    ...
    # find /opt/vmware/web/ -xdev -type f -a '(' -perm -o+w -o -not -user root -o -not -group root ')' -exec ls -ld {} \\;
  ...
  tag gid: 'V-VCFJ-9X-000043'
  tag rid: 'SV-VCFJ-9X-000043'
  tag stig_id: 'VCFJ-9X-000043'
  tag cci: ['CCI-001082']
  tag nist: ['SC-2']
