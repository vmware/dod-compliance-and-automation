control 'VCFJ-9X-000035' do
  title 'The VMware Cloud Foundation Operations HCX Apache HTTP service must constrain users and scripts running on behalf of users to the document root or home directory tree of the web server.'
  desc  "
  ...
  tag gid: 'V-VCFJ-9X-000035'
  tag rid: 'SV-VCFJ-9X-000035'
  tag stig_id: 'VCFJ-9X-000035'
