control 'VCFB-9X-000010' do
  title 'The VMware Cloud Foundation SDDC Manager NGINX server must produce log records containing sufficient information to establish what type of events occurred.'
  desc  "
  ...
  tag gid: 'V-VCFB-9X-000010'
  tag rid: 'SV-VCFB-9X-000010'
  tag stig_id: 'VCFB-9X-000010'
