control 'VCFB-9X-000099' do
  title 'The VMware Cloud Foundation SDDC Manager NGINX server must disable server side includes.'
  ...
  tag gid: 'V-VCFB-9X-000099'
  tag rid: 'SV-VCFB-9X-000099'
  tag stig_id: 'VCFB-9X-000099'
  tag cci: ['CCI-000366']
  tag nist: ['CM-6 b']
