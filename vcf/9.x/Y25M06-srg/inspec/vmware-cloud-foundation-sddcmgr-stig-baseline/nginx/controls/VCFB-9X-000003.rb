control 'VCFB-9X-000003' do
  ...
  desc  'check', "
    ...
    # nginx -T 2>&1 | sed -n '/\\sserver\\s{/{:a;N;/.*location/!ba;/.*listen.*ssl/p}' | grep listen
  ...
  tag gid: 'V-VCFB-9X-000003'
  tag rid: 'SV-VCFB-9X-000003'
  tag stig_id: 'VCFB-9X-000003'
