control 'VCFC-9X-000007' do
  title 'The VMware Cloud Foundation SDDC Manager PostgreSQL service must generate audit records.'
  desc  "
  ...
  tag gid: 'V-VCFC-9X-000007'
  tag rid: 'SV-VCFC-9X-000007'
  tag stig_id: 'VCFC-9X-000007'
