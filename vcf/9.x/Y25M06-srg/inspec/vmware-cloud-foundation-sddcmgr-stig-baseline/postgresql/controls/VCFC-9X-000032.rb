control 'VCFC-9X-000032' do
  title 'The VMware Cloud Foundation SDDC Manager PostgreSQL service must not load unused database components, software, and database objects.'
  desc  "
  ...
  tag gid: 'V-VCFC-9X-000032'
  tag rid: 'SV-VCFC-9X-000032'
  tag stig_id: 'VCFC-9X-000032'
  tag cci: ['CCI-000381']
  tag nist: ['CM-7 a']
