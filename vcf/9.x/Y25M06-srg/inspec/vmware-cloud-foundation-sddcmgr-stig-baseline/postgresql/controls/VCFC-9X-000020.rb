control 'VCFC-9X-000020' do
  title 'The VMware Cloud Foundation SDDC Manager PostgreSQL service must be configured to protect log files from unauthorized access.'
  desc  "
  ...
  tag gid: 'V-VCFC-9X-000020'
  tag rid: 'SV-VCFC-9X-000020'
  tag stig_id: 'VCFC-9X-000020'
