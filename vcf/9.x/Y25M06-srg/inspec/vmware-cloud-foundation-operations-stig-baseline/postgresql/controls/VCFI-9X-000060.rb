control 'VCFI-9X-000060' do
  title 'The VMware Cloud Foundation Operations PostgreSQL service must provide nonprivileged users with minimal error information.'
  desc  "
  ...
  tag gid: 'V-VCFI-9X-000060'
  tag rid: 'SV-VCFI-9X-000060'
  tag stig_id: 'VCFI-9X-000060'
