control 'VCFH-9X-000061' do
  title 'The VMware Cloud Foundation Operations Apache HTTP service must restrict the ability of users to launch Denial of Service (DoS) attacks against other information systems or networks.'
  desc  "
  ...
  desc  'check', "
    ...
    # grep -i \"Timeout\"  /etc/httpd/conf/httpd.conf /etc/httpd/conf/extra/httpd-ssl.conf /usr/lib/vmware-vcopssuite/utilities/conf/vcops-apache.conf
  ...
  tag gid: 'V-VCFH-9X-000061'
  tag rid: 'SV-VCFH-9X-000061'
  tag stig_id: 'VCFH-9X-000061'
