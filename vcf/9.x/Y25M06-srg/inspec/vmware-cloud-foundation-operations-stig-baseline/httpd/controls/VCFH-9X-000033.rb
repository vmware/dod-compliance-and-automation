control 'VCFH-9X-000033' do
  ...
  desc 'fix', "
    ...
    # grep -i \"dav_module\" /etc/httpd/conf/httpd.conf /etc/httpd/conf/extra/httpd-ssl.conf /usr/lib/vmware-vcopssuite/utilities/conf/vcops-apache.conf
  ...
  tag gid: 'V-VCFH-9X-000033'
  tag rid: 'SV-VCFH-9X-000033'
  tag stig_id: 'VCFH-9X-000033'
  tag cci: ['CCI-000381']
  tag nist: ['CM-7 a']
