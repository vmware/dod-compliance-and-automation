control 'VCFA-9X-000368' do
  title 'VMware Cloud Foundation Operations must configure Operations for Networks to compare internal information system clocks with an authoritative time server.'
  desc  "
  ...
  desc  'check', "
    ...
    Click \"Manage\" on the operations-networks capability and view the currently configured NTP servers.
  ...
  desc 'fix', "
    ...
    Click \"Manage\" on the operations-networks capability.
  ...
  tag gid: 'V-VCFA-9X-000368'
  tag rid: 'SV-VCFA-9X-000368'
  tag stig_id: 'VCFA-9X-000368'
  tag cci: ['CCI-004923']
  tag nist: ['SC-45 (1) (a)']
