control 'VCFN-9X-000040' do
  title 'The VMware Cloud Foundation NSX Manager must enforce password complexity by requiring that at least one lowercase character be used for local accounts.'
  desc  "
  ...
  tag gid: 'V-VCFN-9X-000040'
  tag rid: 'SV-VCFN-9X-000040'
  tag stig_id: 'VCFN-9X-000040'
  tag cci: ['CCI-004066']
  tag nist: ['IA-5 (1) (h)']
