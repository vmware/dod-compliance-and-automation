control 'VCFL-9X-000007' do
  title 'The VMware Cloud Foundation vCenter PostgreSQL service must generate audit records.'
  desc  "
  ...
  tag gid: 'V-VCFL-9X-000007'
  tag rid: 'SV-VCFL-9X-000007'
  tag stig_id: 'VCFL-9X-000007'
