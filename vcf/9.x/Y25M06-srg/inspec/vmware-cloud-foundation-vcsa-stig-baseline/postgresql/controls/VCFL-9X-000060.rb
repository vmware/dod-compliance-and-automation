control 'VCFL-9X-000060' do
  title 'The VMware Cloud Foundation vCenter PostgreSQL service must provide nonprivileged users with minimal error information.'
  desc  "
  ...
  tag gid: 'V-VCFL-9X-000060'
  tag rid: 'SV-VCFL-9X-000060'
  tag stig_id: 'VCFL-9X-000060'
