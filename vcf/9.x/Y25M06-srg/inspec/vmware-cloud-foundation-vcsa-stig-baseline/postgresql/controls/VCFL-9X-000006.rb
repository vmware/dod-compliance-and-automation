control 'VCFL-9X-000006' do
  title 'The VMware Cloud Foundation vCenter PostgreSQL service configuration files must not be accessible by unauthorized users.'
  desc  "
  ...
  tag gid: 'V-VCFL-9X-000006'
  tag rid: 'SV-VCFL-9X-000006'
  tag stig_id: 'VCFL-9X-000006'
