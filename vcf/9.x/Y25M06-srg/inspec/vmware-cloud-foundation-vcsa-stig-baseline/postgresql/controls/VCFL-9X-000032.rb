control 'VCFL-9X-000032' do
  title 'The VMware Cloud Foundation vCenter PostgreSQL service must not load unused database components, software, and database objects.'
  desc  "
  ...
  tag gid: 'V-VCFL-9X-000032'
  tag rid: 'SV-VCFL-9X-000032'
  tag stig_id: 'VCFL-9X-000032'
  tag cci: ['CCI-000381']
  tag nist: ['CM-7 a']
