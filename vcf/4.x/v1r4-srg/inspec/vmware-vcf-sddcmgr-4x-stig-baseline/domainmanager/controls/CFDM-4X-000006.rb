control 'CFDM-4X-000006' do
  title 'The SDDC Manager Domain Manager service files must be verified for their integrity.'
  ...
  desc  'check', "
    ...
    # rpm -V vcf-domain-manager | grep \"^..5......\" | grep -v -E \"/etc|application.*properties\"
  ...
  tag gid: 'V-CFDM-4X-000006'
  tag rid: 'SV-CFDM-4X-000006'
  tag stig_id: 'CFDM-4X-000006'
  tag cci: ['CCI-001749']
  tag nist: ['CM-5 (3)']

  describe command('rpm -V vcf-domain-manager | grep \"^..5......\" | grep -v -E "/etc|application.*properties"') do
