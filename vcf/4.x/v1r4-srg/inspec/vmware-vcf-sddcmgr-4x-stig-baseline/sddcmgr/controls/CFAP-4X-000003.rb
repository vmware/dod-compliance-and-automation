control 'CFAP-4X-000003' do
  ...
  desc  'rationale', ''
  desc  'check', "
    SDDC Manager and Cloud Foundation updates are generally released as a group update to the bill of materials. SDDC Manager orchestrates the installation of updates to the management and workload domain components such as vSphere and NSX-T.
    ...
    https://docs.vmware.com/en/VMware-Cloud-Foundation/4.5/vcf-lifecycle/GUID-8FA44ACE-8F04-47DA-845E-E0863094F7B0.html
  ...
  "
  desc 'fix', "
    To apply patches and updates to SDDC Manager/Cloud Foundation, follow the guidance in the Lifecycle Management section found in the URL below.

    https://docs.vmware.com/en/VMware-Cloud-Foundation/4.5/vcf-lifecycle/GUID-B384B08D-3652-45E2-8AA9-AF53066F5F70.html
  "
  impact 0.7
  tag severity: 'high'
  tag gtitle: 'SRG-APP-000456-AS-000266'
  tag gid: 'V-CFAP-4X-000003'
  tag rid: 'SV-CFAP-4X-000003'
