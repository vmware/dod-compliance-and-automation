control 'CFAP-4X-000005' do
  ...
  desc  'Allowing access to the SDDC Manager appliance from the internet or externally to the organization could expose the server to denial of service (DoS) attacks or other penetration attempts.'
  desc  'rationale', ''
  desc  'check', "
  ...
  tag gid: 'V-CFAP-4X-000005'
  tag rid: 'SV-CFAP-4X-000005'
