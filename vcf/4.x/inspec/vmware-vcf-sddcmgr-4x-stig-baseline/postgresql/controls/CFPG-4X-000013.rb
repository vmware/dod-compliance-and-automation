control 'CFPG-4X-000013' do
  title 'The SDDC Manager PostgreSQL service must be configured to use the correct port.'
  desc  "
  ...
  desc  'check', "
    ...
    # psql -h localhost -U postgres -A -t -c \"SHOW port\"
