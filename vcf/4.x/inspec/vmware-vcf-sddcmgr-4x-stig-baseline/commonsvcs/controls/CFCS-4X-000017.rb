control 'CFCS-4X-000017' do
  title 'The SDDC Manager Common Services service must not enable server information to be displayed.'
  ...
  desc  'check', "
    ...
    # grep server.server-header /opt/vmware/vcf/commonsvcs/conf/application-prod.properties
  ...
  tag gid: 'V-CFCS-4X-000017'
  tag rid: 'SV-CFCS-4X-000017'
  tag stig_id: 'CFCS-4X-000017'
  tag cci: ['CCI-001312']
  tag nist: ['SI-11 a']
