control 'CFCS-4X-000001' do
  title 'The SDDC Manager Common Services service must enabled to generate service runtime logs.'
  desc  "
  ...
  tag gid: 'V-CFCS-4X-000001'
  tag rid: 'SV-CFCS-4X-000001'
  tag stig_id: 'CFCS-4X-000001'
  tag cci: ['CCI-000130']
  tag nist: ['AU-3']
