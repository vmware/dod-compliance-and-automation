...
Use the **Avi-branded** zip below for checks that match this repository’s **30.x** wording (titles, check text, and fix text aligned with the InSpec profile).

## XCCDF zip bundle in this directory

### **`U_VMware_AVI_Load_Balancer_STIG_Readiness_Guide_30.x.zip`**
