control 'NALB-SE-000072' do
  title 'The VMware Avi Load Balancer must enable WAF policy signatures to detect and prevent code injection attacks.'
  desc  "
  ...
  desc  'rationale', ''
  desc  'check', "
    Review virtual services on the Avi Service Engine to verify WAF CRS groups are enabled.
