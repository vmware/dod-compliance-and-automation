control 'VLMN-8X-000019' do
  title 'The VMware Aria Suite Lifecycle web service log files must only be accessible by privileged users.'
  desc  "
  ...
  tag gid: 'V-VLMN-8X-000019'
  tag rid: 'SV-VLMN-8X-000019'
  tag stig_id: 'VLMN-8X-000019'
