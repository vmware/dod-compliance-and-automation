control 'VLMP-8X-000032' do
  title 'VMware Aria Suite Lifecycle vpostgres must not load unused database components, software, and database objects.'
  desc  "
  ...
  desc  'check', "
    ...
    $ /opt/vmware/vpostgres/current/bin/psql -U postgres -A -t -c \"select extname from pg_extension where extname != 'plpgsql'\"
  ...
  tag gid: 'V-VLMP-8X-000032'
  tag rid: 'SV-VLMP-8X-000032'
  tag stig_id: 'VLMP-8X-000032'
  tag cci: ['CCI-000381']
  tag nist: ['CM-7 a']
