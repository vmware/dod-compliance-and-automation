control 'VLMN-8X-000100' do
  title 'The VMware Aria Suite Lifecycle web service must not disable keep alive timeouts.'
  desc  "
  ...
  tag gid: 'V-VLMN-8X-000100'
  tag rid: 'SV-VLMN-8X-000100'
  tag stig_id: 'VLMN-8X-000100'
  tag cci: ['CCI-000366']
  tag nist: ['CM-6 b']
