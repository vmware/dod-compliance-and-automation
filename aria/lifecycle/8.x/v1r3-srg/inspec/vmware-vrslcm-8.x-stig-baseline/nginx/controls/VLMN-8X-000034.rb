control 'VLMN-8X-000034' do
  title 'The VMware Aria Suite Lifecycle web service must have Web Distributed Authoring (WebDAV) disabled.'
  desc  "
  ...
  desc  'rationale', ''
  desc  'check', "
    Verify the web service is not complied with the WebDAV module.
  ...
  tag gid: 'V-VLMN-8X-000034'
  tag rid: 'SV-VLMN-8X-000034'
  tag stig_id: 'VLMN-8X-000034'
  tag cci: ['CCI-000381']
  tag nist: ['CM-7 a']
