control 'VLMN-8X-000026' do
  title 'The VMware Aria Suite Lifecycle web service must only contain modules necessary for operation.'
  desc  "
  ...
  desc  'rationale', ''
  desc  'check', "
    Verify the web service is not complied with unused modules.
  ...
  tag gid: 'V-VLMN-8X-000026'
  tag rid: 'SV-VLMN-8X-000026'
  tag stig_id: 'VLMN-8X-000026'
  tag cci: ['CCI-000381']
  tag nist: ['CM-7 a']
