control 'VLMN-8X-000001' do
  title 'The VMware Aria Suite Lifecycle web service must limit the number of allowed simultaneous session requests.'
  desc  "
  ...
  tag gid: 'V-VLMN-8X-000001'
  tag rid: 'SV-VLMN-8X-000001'
  tag stig_id: 'VLMN-8X-000001'
  tag cci: ['CCI-000054']
  tag nist: ['AC-10']
