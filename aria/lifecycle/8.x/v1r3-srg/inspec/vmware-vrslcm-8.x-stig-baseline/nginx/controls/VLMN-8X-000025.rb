control 'VLMN-8X-000025' do
  title 'The VMware Aria Suite Lifecycle web service must not perform user management for hosted applications.'
  desc  "
  ...
  desc 'fix', "
    ...
    If they can be safely removed navigate to and open the nginx.conf file (/etc/nginx/nginx.conf by default or the included file where the server is defined).
  ...
  tag gid: 'V-VLMN-8X-000025'
  tag rid: 'SV-VLMN-8X-000025'
  tag stig_id: 'VLMN-8X-000025'
  tag cci: ['CCI-000381']
  tag nist: ['CM-7 a']
