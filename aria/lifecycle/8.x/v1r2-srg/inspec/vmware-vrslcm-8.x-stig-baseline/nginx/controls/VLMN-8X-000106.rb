control 'VLMN-8X-000106' do
  title 'The VMware Aria Suite Lifecycle web service must configure the Referrer-Policy header.'
  ...
  tag gid: 'V-VLMN-8X-000106'
  tag rid: 'SV-VLMN-8X-000106'
  tag stig_id: 'VLMN-8X-000106'
  tag cci: ['CCI-000366']
  tag nist: ['CM-6 b']
