control 'VLMN-8X-000096' do
  title 'The VMware Aria Suite Lifecycle web service must remove the default web site configuration.'
  ...
  tag gid: 'V-VLMN-8X-000096'
  tag rid: 'SV-VLMN-8X-000096'
  tag stig_id: 'VLMN-8X-000096'
  tag cci: ['CCI-000366']
  tag nist: ['CM-6 b']
