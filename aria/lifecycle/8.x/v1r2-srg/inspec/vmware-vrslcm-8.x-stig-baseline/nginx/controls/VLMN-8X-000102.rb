control 'VLMN-8X-000102' do
  title 'The VMware Aria Suite Lifecycle web service must disable SSL session tickets.'
  ...
  tag gid: 'V-VLMN-8X-000102'
  tag rid: 'SV-VLMN-8X-000102'
  tag stig_id: 'VLMN-8X-000102'
  tag cci: ['CCI-000366']
  tag nist: ['CM-6 b']
