control 'VLMN-8X-000098' do
  title 'The VMware Aria Suite Lifecycle web service must prefer server ciphers over client ciphers when using SSL/TLS.'
  ...
  desc  'check', "
    ...
    If the \"ssl_prefer_server_ciphers\" directive is not configured in the http block or is set to off, this is a finding.
  ...
  tag gid: 'V-VLMN-8X-000098'
  tag rid: 'SV-VLMN-8X-000098'
  tag stig_id: 'VLMN-8X-000098'
  tag cci: ['CCI-002418']
  tag nist: ['SC-8']
