control 'VLMP-8X-000114' do
  title 'VMware Aria Suite Lifecycle vpostgres must log all client disconnections.'
  desc  "
  ...
  desc 'fix', "
    ...
    $ /opt/vmware/vpostgres/current/bin/psql -U postgres -c \"ALTER SYSTEM SET log_disconnections TO 'on';\"

    Restart the VMware Aria Suite Lifecycle vpostgres service by running the following command:
  ...
  tag gid: 'V-VLMP-8X-000114'
  tag rid: 'SV-VLMP-8X-000114'
  tag stig_id: 'VLMP-8X-000114'
  tag cci: ['CCI-000172']
  tag nist: ['AU-12 c']
