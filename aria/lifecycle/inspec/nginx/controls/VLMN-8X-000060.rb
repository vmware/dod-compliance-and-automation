control 'VLMN-8X-000060' do
  title 'The VMware Aria Suite Lifecycle web service must restrict the ability of users to launch Denial of Service (DoS) attacks against other information systems or networks.'
  ...
  tag gid: 'V-VLMN-8X-000060'
  tag rid: 'SV-VLMN-8X-000060'
  tag stig_id: 'VLMN-8X-000060'
  tag cci: %w(CCI-001094 CCI-002385)
  tag nist: ['SC-5', 'SC-5 (1)']
