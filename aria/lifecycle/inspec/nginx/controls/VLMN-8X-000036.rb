control 'VLMN-8X-000036' do
  title 'The VMware Aria Suite Lifecycle web service must not have any symbolic links that traverse outside the web content directory tree.'
  desc  "
  ...
  tag gid: 'V-VLMN-8X-000036'
  tag rid: 'SV-VLMN-8X-000036'
  tag stig_id: 'VLMN-8X-000036'
  tag cci: %w(CCI-000381 CCI-001084)
