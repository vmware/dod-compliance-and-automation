control 'VLMN-8X-000097' do
  title 'The VMware Aria Suite Lifecycle web service must remove references of server information from default web pages.'
  desc  "
  ...
  tag gid: 'V-VLMN-8X-000097'
  tag rid: 'SV-VLMN-8X-000097'
  tag stig_id: 'VLMN-8X-000097'
  tag cci: ['CCI-001312']
  tag nist: ['SI-11 a']
