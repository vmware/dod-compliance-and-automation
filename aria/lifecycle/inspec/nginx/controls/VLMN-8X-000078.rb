control 'VLMN-8X-000078' do
  title 'The VMware Aria Suite Lifecycle web service configuration files must only be accessible to privileged users.'
  desc  "
  ...
  tag satisfies: %w(SRG-APP-000211-WSR-000030 SRG-APP-000340-WSR-000029)
  tag gid: 'V-VLMN-8X-000078'
  tag rid: 'SV-VLMN-8X-000078'
  tag stig_id: 'VLMN-8X-000078'
  tag cci: %w(CCI-001082 CCI-001813 CCI-002235)
