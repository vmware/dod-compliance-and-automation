control 'VLMN-8X-000063' do
  title 'The VMware Aria Suite Lifecycle web service must minimize the identity of the web server in information displayed to clients.'
  desc  "
  ...
  tag gid: 'V-VLMN-8X-000063'
  tag rid: 'SV-VLMN-8X-000063'
  tag stig_id: 'VLMN-8X-000063'
  tag cci: ['CCI-001312']
  tag nist: ['SI-11 a']
