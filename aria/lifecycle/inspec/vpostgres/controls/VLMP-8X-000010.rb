control 'VLMP-8X-000010' do
  title 'VMware Aria Suite Lifecycle vpostgres must produce logs containing sufficient information to establish what type of events occurred.'
  desc  "
  ...
  desc 'fix', "
    ...
    $ /opt/vmware/vpostgres/current/bin/psql -U postgres -c \"ALTER SYSTEM SET log_line_prefix = '%m %c %x %d %u %r %p %l';\"
  ...
  tag satisfies: %w(SRG-APP-000096-DB-000040 SRG-APP-000097-DB-000041 SRG-APP-000098-DB-000042 SRG-APP-000099-DB-000043 SRG-APP-000100-DB-000201 SRG-APP-000101-DB-000044 SRG-APP-000375-DB-000323)
  tag gid: 'V-VLMP-8X-000010'
  tag rid: 'SV-VLMP-8X-000010'
  tag stig_id: 'VLMP-8X-000010'
  tag cci: %w(CCI-000130 CCI-000131 CCI-000132 CCI-000133 CCI-000134 CCI-000135 CCI-001487 CCI-001889)
