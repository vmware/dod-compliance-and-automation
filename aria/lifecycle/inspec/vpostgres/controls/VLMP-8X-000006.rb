control 'VLMP-8X-000006' do
  title 'VMware Aria Suite Lifecycle vpostgres configuration files must not be accessible by unauthorized users.'
  desc  "
  ...
  desc  'check', "
    ...
    Note: Substitute the path for the location of your vpostgres configuration files.
  ...
  tag satisfies: %w(SRG-APP-000121-DB-000202 SRG-APP-000122-DB-000203 SRG-APP-000123-DB-000204 SRG-APP-000380-DB-000360)
  tag gid: 'V-VLMP-8X-000006'
  tag rid: 'SV-VLMP-8X-000006'
  tag stig_id: 'VLMP-8X-000006'
  tag cci: %w(CCI-000171 CCI-001493 CCI-001494 CCI-001495 CCI-001813)
