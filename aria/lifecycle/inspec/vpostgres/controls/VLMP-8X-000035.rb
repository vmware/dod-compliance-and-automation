control 'VLMP-8X-000035' do
  title 'VMware Aria Suite Lifecycle vpostgres must be configured to use an authorized port.'
  desc  "
  ...
  desc 'fix', "
    ...
    $ /opt/vmware/vpostgres/current/bin/psql -U postgres -c \"ALTER SYSTEM SET port = 5432;\"
  ...
  tag gid: 'V-VLMP-8X-000035'
  tag rid: 'SV-VLMP-8X-000035'
  tag stig_id: 'VLMP-8X-000035'
