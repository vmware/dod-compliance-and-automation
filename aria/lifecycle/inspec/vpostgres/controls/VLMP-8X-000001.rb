control 'VLMP-8X-000001' do
  title 'VMware Aria Suite Lifecycle vpostgres must limit the number of concurrent sessions.'
  desc  "
  ...
  desc 'fix', "
    ...
    $ /opt/vmware/vpostgres/current/bin/psql -U postgres -c \"ALTER SYSTEM SET max_connections = 100;\"
  ...
  tag gid: 'V-VLMP-8X-000001'
  tag rid: 'SV-VLMP-8X-000001'
  tag stig_id: 'VLMP-8X-000001'
  tag cci: ['CCI-000054']
  tag nist: ['AC-10']
