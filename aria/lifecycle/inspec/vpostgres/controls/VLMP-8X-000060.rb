control 'VLMP-8X-000060' do
  title 'VMware Aria Suite Lifecycle vpostgres must provide non-privileged users with minimal error information.'
  desc  "
  ...
  desc 'fix', "
    ...
    $ /opt/vmware/vpostgres/current/bin/psql -U postgres -c \"ALTER SYSTEM SET client_min_messages TO 'error';\"
  ...
  tag gid: 'V-VLMP-8X-000060'
  tag rid: 'SV-VLMP-8X-000060'
  tag stig_id: 'VLMP-8X-000060'
