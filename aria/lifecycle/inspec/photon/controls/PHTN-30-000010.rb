control 'PHTN-30-000010' do
  ...
  tag satisfies: %w(SRG-OS-000039-GPOS-00017 SRG-OS-000040-GPOS-00018 SRG-OS-000041-GPOS-00019)
  tag gid: 'V-PHTN-30-000010'
  tag rid: 'SV-PHTN-30-000010'
  tag stig_id: 'PHTN-30-000010'
  tag cci: %w(CCI-000130 CCI-000132 CCI-000133 CCI-000134)
  tag nist: ['AU-3']
