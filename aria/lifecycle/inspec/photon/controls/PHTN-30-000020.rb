control 'PHTN-30-000020' do
  ...
  tag satisfies: %w(SRG-OS-000392-GPOS-00172 SRG-OS-000462-GPOS-00206 SRG-OS-000466-GPOS-00210 SRG-OS-000468-GPOS-00212)
  tag gid: 'V-PHTN-30-000020'
  tag rid: 'SV-PHTN-30-000020'
