control 'VRPS-8X-000034' do
  title 'The Casa service must limit privileges for creating or modifying hosted application shared files.'
  desc  "
  ...
  desc  'check', "
    ...
    # xmllint --xpath \"//*[contains(@className, 'SecurityListener')]/parent::*\" $CATALINA_BASE/conf/server.xml
