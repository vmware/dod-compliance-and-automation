control 'VRPS-8X-000144' do
  title 'The Casa service files must have permissions in an out-of-the-box state.'
  ...
  desc  'check', "
    ...
    # find $CATALINA_BASE/conf -xdev -type f -a '(' -perm -o+w -o -not -user admin -o -not -group admin ')' -exec ls -ld {} \\;
