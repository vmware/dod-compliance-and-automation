control 'VRPS-8X-000001' do
  title 'The Casa service must limit the number of maximum concurrent connections permitted.'
  desc  "
  ...
  desc  'check', "
    ...
    # xmllint --xpath \"//Executor[not(@maxThreads)]/@name | //Executor[@maxThreads != '200']/@name\" $CATALINA_BASE/conf/server.xml | awk 1 RS=' '
    # xmllint --xpath \"//Connector[not(@maxThreads)]/@port | //Connector[@maxThreads != '200']/@port\" $CATALINA_BASE/conf/server.xml | awk 1 RS=' '
