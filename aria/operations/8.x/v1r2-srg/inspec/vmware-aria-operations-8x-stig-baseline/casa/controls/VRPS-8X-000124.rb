control 'VRPS-8X-000124' do
  title 'The Casa service must enable "STRICT_SERVLET_COMPLIANCE".'
  desc  "
  ...
  desc  'check', "
    ...
    # grep STRICT_SERVLET_COMPLIANCE $CATALINA_BASE/conf/catalina.properties
  ...
  desc 'fix', "
    ...
    Navigate to and open the $CATALINA_BASE/conf/context.xml file.
  ...
  tag gid: 'V-VRPS-8X-000124'
  tag rid: 'SV-VRPS-8X-000124'
  tag stig_id: 'VRPS-8X-000124'
  tag cci: ['CCI-000366']
  tag nist: ['CM-6 b']

  describe parse_config_file("#{input('casa-catalinaPropsPath')}").params['org.apache.catalina.STRICT_SERVLET_COMPLIANCE'] do
    it { should cmp 'true' }
  end
end
