control 'VRPI-8X-000014' do
  title 'The API service must produce log records containing sufficient information regarding event details.'
  desc  "
  ...
  tag gid: 'V-VRPI-8X-000014'
  tag rid: 'SV-VRPI-8X-000014'
  tag stig_id: 'VRPI-8X-000014'
  ...
  xmlconf['//*/Valve[@className="org.apache.catalina.valves.AccessLogValve"]/@pattern'].each do |pattern|
    ...
    input('api-accessLogPattern').each do |item|
      describe pattern do
  ...
  input('api-contextXmlFiles').each do |context|
