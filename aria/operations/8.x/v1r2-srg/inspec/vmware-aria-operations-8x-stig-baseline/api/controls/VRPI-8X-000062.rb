control 'VRPI-8X-000062' do
  title 'The API service must be built to fail to a known safe state if system initialization fails, shutdown fails, or aborts fail.'
  ...
  desc  'check', "
    ...
    # grep -i EXIT_ON_INIT_FAILURE $CATALINA_BASE/conf/catalina.properties
