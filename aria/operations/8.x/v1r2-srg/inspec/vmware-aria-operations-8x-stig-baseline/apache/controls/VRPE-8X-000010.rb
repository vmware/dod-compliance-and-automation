control 'VRPE-8X-000010' do
  title 'The vRealize Operations Manager Apache servers users and scripts running on behalf of users must be contained to the document root or home directory tree of the web server.'
  desc  "
