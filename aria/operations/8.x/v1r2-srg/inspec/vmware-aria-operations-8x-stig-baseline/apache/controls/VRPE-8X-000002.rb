control 'VRPE-8X-000002' do
  title 'The vRealize Operations Manager Apache server must use encryption strength in accordance with the categorization of data hosted by the web server when remote connections are provided.'
  desc  "
  ...
  tag satisfies: %w[SRG-APP-000416-WSR-000118 SRG-APP-000439-WSR-000188]
  tag gid: 'V-VRPE-8X-000002'
  tag rid: 'SV-VRPE-8X-000002'
  tag stig_id: 'VRPE-8X-000002'
  tag cci: %w[CCI-000068 CCI-002418 CCI-002450]
