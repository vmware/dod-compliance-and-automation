control 'VRPP-8X-000044' do
  ...
  tag satisfies: %w[SRG-APP-000416-DB-000380 SRG-APP-000514-DB-000381 SRG-APP-000514-DB-000382 SRG-APP-000514-DB-000383]
  tag gid: 'V-VRPP-8X-000044'
  tag rid: 'SV-VRPP-8X-000044'
  tag stig_id: 'VRPP-8X-000044'
  ...
  describe command('openssl md5 /etc/issue 2>&1') do
