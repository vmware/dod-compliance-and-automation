control 'VRPS-8X-000070' do
  title 'The VMware Aria Operations Casa service must set an inactive timeout for sessions.'
  ...
  desc  'check', "
    ...
    # xmllint --xpath \"//*[local-name()='session-timeout']/parent::*\" /usr/lib/vmware-casa/casa-webapp/conf/web.xml
