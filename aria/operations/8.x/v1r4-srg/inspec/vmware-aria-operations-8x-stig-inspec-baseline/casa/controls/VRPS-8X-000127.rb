control 'VRPS-8X-000127' do
  title 'The VMware Aria Operations Casa service must configure the "setCharacterEncodingFilter" filter.'
  desc  "
  ...
  desc  'check', "
    ...
    # xmllint --xpath \"//*[contains(text(), 'SetCharacterEncodingFilter')]/parent::*\" /usr/lib/vmware-casa/casa-webapp/conf/web.xml
  ...
  tag gid: 'V-VRPS-8X-000127'
  tag rid: 'SV-VRPS-8X-000127'
  tag stig_id: 'VRPS-8X-000127'
  tag cci: ['CCI-001310']
  tag nist: ['SI-10']
  # Open web.xml
