control 'VRPS-8X-000136' do
  title 'The VMware Aria Operations Casa service debug parameter must be disabled.'
  desc  "
  ...
  tag gid: 'V-VRPS-8X-000136'
  tag rid: 'SV-VRPS-8X-000136'
  tag stig_id: 'VRPS-8X-000136'
  tag cci: ['CCI-000381']
  tag nist: ['CM-7 a']
