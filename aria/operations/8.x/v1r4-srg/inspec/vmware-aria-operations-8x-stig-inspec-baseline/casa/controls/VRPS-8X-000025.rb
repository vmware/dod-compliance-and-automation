control 'VRPS-8X-000025' do
  title 'The VMware Aria Operations Casa service logs folder permissions must be set correctly.'
  ...
  desc  'check', "
    ...
    # find /usr/lib/vmware-casa/casa-webapp/logs/ -xdev -type f -a '(' -perm -o+w -o -not -user admin -o -not -group admin ')' -exec ls -ld {} \\;
