control 'VRPS-8X-000036' do
  title 'The VMware Aria Operations Casa service must disable stack tracing.'
  ...
  desc  'check', "
    ...
    # xmllint --xpath \"//Connector[@allowTrace]\" /usr/lib/vmware-casa/casa-webapp/conf/server.xml
