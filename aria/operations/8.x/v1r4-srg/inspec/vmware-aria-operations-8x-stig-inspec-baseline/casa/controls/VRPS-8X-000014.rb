control 'VRPS-8X-000014' do
  title 'The VMware Aria Operations Casa service must produce log records containing sufficient information regarding event details.'
  desc  "
  ...
  desc  'check', "
    ...
    # xmllint --xpath '/Server/Service/Engine/Host/Valve[@className=\"org.apache.catalina.valves.AccessLogValve\"]/@pattern' /usr/lib/vmware-casa/casa-webapp/conf/server.xml
