control 'VRPS-8X-000142' do
  title 'The VMware Aria Operations Casa service default ROOT web application must be removed.'
  ...
  desc  'check', "
    ...
    # ls -l /usr/lib/vmware-casa/casa-webapp/webapps/ROOT
  ...
  desc 'fix', "
    ...
    # rm -rf /usr/lib/vmware-casa/casa-webapp/webapps/ROOT
  "
  impact 0.5
  tag severity: 'medium'
