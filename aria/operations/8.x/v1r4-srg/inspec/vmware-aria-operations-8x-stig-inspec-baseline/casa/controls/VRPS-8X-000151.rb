control 'VRPS-8X-000151' do
  title 'The VMware Aria Operations Casa service must disable "ALLOW_BACKSLASH".'
  ...
  desc  'check', "
    ...
    # grep -i ALLOW_BACKSLASH /usr/lib/vmware-casa/casa-webapp/conf/catalina.properties
  ...
  tag gid: 'V-VRPS-8X-000151'
  tag rid: 'SV-VRPS-8X-000151'
  tag stig_id: 'VRPS-8X-000151'
  tag cci: ['CCI-000366']
  tag nist: ['CM-6 b']

  describe parse_config_file("#{input('casa-catalinaPropsPath')}").params['org.apache.catalina.connector.ALLOW_BACKSLASH'] do
