control 'VRPS-8X-000067' do
  title 'The VMware Aria Operations Casa service "ErrorReportValve showServerInfo" must be set to "false".'
  ...
  desc  'check', "
    ...
    # xmllint --xpath \"//*[contains(@className, 'ErrorReportValve')]/parent::*\" /usr/lib/vmware-casa/casa-webapp/conf/server.xml
  ...
  tag gid: 'V-VRPS-8X-000067'
  tag rid: 'SV-VRPS-8X-000067'
  tag stig_id: 'VRPS-8X-000067'
  tag cci: ['CCI-001312']
  tag nist: ['SI-11 a']
