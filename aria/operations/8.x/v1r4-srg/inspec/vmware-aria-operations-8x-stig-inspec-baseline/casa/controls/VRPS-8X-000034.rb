control 'VRPS-8X-000034' do
  title 'The VMware Aria Operations Casa service must limit privileges for creating or modifying hosted application shared files.'
  desc  "
  ...
  desc  'check', "
    ...
    # xmllint --xpath \"//*[contains(@className, 'SecurityListener')]/parent::*\" /usr/lib/vmware-casa/casa-webapp/conf/server.xml
  ...
  "
  desc 'fix', "
    Edit the /usr/lib/vmware-casa/casa-webapp/conf/server.xml file.
  ...
  tag gid: 'V-VRPS-8X-000034'
  tag rid: 'SV-VRPS-8X-000034'
  tag stig_id: 'VRPS-8X-000034'
  tag cci: ['CCI-001499']
  tag nist: ['CM-5 (6)']
