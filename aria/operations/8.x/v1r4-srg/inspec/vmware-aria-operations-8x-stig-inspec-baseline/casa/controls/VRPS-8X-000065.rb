control 'VRPS-8X-000065' do
  title 'The VMware Aria Operations Casa service must set URIEncoding to UTF-8.'
  desc  "
  ...
  desc  'check', "
    ...
    # xmllint --xpath \"//Connector[not(@URIEncoding)] | //Connector[@URIEncoding != 'UTF-8']\" /usr/lib/vmware-casa/casa-webapp/conf/server.xml | awk 1 RS='<Connector' ORS='\
    <Connector'
  ...
  tag gid: 'V-VRPS-8X-000065'
  tag rid: 'SV-VRPS-8X-000065'
  tag stig_id: 'VRPS-8X-000065'
  tag cci: ['CCI-001310']
  tag nist: ['SI-10']
