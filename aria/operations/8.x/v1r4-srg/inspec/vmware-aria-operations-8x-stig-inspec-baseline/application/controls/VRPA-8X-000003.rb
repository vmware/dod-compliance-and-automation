control 'VRPA-8X-000003' do
  title 'VMware Aria Operations must back up log records at least every seven days onto a different system or system component than the system or component being logged.'
  ...
  tag satisfies: ['SRG-APP-000181-AS-000255', 'SRG-APP-000356-AS-000202', 'SRG-APP-000358-AS-000064', 'SRG-APP-000515-AS-000203']
