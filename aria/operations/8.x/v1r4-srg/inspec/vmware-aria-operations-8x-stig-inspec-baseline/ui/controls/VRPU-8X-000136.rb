control 'VRPU-8X-000136' do
  title 'The VMware Aria Operations UI service debug parameter must be disabled.'
  desc  "
  ...
  tag gid: 'V-VRPU-8X-000136'
  tag rid: 'SV-VRPU-8X-000136'
  tag stig_id: 'VRPU-8X-000136'
  tag cci: ['CCI-000381']
  tag nist: ['CM-7 a']
