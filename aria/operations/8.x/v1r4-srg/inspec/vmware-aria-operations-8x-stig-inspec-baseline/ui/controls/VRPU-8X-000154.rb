control 'VRPU-8X-000154' do
  title 'The VMware Aria Operations UI service manager webapp must be removed.'
  ...
  desc  'check', "
    ...
    # ls -l /usr/lib/vmware-vcops/tomcat-web-app/webapps/manager
  ...
  desc 'fix', "
    ...
    # rm -rf /usr/lib/vmware-vcops/tomcat-web-app/webapps/manager
  "
  impact 0.5
  tag severity: 'medium'
  tag gtitle: 'SRG-APP-000141-AS-000095'
  tag gid: 'V-VRPU-8X-000154'
  tag rid: 'SV-VRPU-8X-000154'
  tag stig_id: 'VRPU-8X-000154'
  tag cci: ['CCI-000381']
  tag nist: ['CM-7 a']

  # Make sure the manager directory does not exist
  describe directory("#{input('ui-tcInstance')}/webapps/manager").exist? do
    it { should cmp 'false' }
  end
end
