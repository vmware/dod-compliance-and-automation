control 'VRPU-8X-000070' do
  title 'The VMware Aria Operations UI service must set an inactive timeout for sessions.'
  ...
  desc  'check', "
    ...
    # xmllint --xpath \"//*[local-name()='session-timeout']/parent::*\" /usr/lib/vmware-vcops/tomcat-web-app/conf/web.xml
  ...
  tag gid: 'V-VRPU-8X-000070'
  tag rid: 'SV-VRPU-8X-000070'
  tag stig_id: 'VRPU-8X-000070'
  ...
  describe xmlconf['//session-config/session-timeout'] do
    it { should eq ["#{input('ui-sessionTimeout')}"] }
  end
end
