control 'VRPU-8X-000144' do
  title 'The VMware Aria Operations UI service files must have permissions in an out-of-the-box state.'
  ...
  desc  'check', "
    ...
    # find /usr/lib/vmware-vcops/tomcat-web-app/conf -xdev -type f -a '(' -perm -o+w -o -not -user admin -o -not -group admin ')' -exec ls -ld {} \\;
