control 'VRPU-8X-000126' do
  title 'The VMware Aria Operations UI service must limit the number of times that each Transmission Control Protocol (TCP) connection is kept alive.'
  desc  "
  ...
  desc  'check', "
    ...
    # xmllint --xpath \"//Connector[@maxKeepAliveRequests = '-1']\" /usr/lib/vmware-vcops/tomcat-web-app/conf/server.xml
  ...
  tag gid: 'V-VRPU-8X-000126'
  tag rid: 'SV-VRPU-8X-000126'
  tag stig_id: 'VRPU-8X-000126'
  tag cci: ['CCI-000054']
  tag nist: ['AC-10']
