control 'VRPU-8X-000137' do
  title 'The VMware Aria Operations UI service directory listings parameter must be disabled.'
  desc  "
  ...
  tag gid: 'V-VRPU-8X-000137'
  tag rid: 'SV-VRPU-8X-000137'
  tag stig_id: 'VRPU-8X-000137'
  tag cci: ['CCI-000381']
  tag nist: ['CM-7 a']
