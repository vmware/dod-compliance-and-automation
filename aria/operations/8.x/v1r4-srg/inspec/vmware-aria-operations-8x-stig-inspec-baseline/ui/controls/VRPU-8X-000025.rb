control 'VRPU-8X-000025' do
  title 'The VMware Aria Operations UI service logs folder permissions must be set correctly.'
  ...
  desc  'check', "
    ...
    # find /usr/lib/vmware-vcops/tomcat-web-app/logs/ -xdev -type f -a '(' -perm -o+w -o -not -user admin -o -not -group admin ')' -exec ls -ld {} \\;
