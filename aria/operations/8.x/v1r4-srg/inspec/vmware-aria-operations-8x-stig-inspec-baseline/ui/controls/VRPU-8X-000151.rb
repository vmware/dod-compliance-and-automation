control 'VRPU-8X-000151' do
  title 'The VMware Aria Operations UI service must disable "ALLOW_BACKSLASH".'
  ...
  desc  'check', "
    ...
    # grep -i ALLOW_BACKSLASH /usr/lib/vmware-vcops/tomcat-web-app/conf/catalina.properties
  ...
  desc 'fix', "
    ...
    # systemctl restart vmware-UI.service
  "
  impact 0.5
  tag severity: 'medium'
  tag gtitle: 'SRG-APP-000516-AS-000237'
  tag gid: 'V-VRPU-8X-000151'
  tag rid: 'SV-VRPU-8X-000151'
  tag stig_id: 'VRPU-8X-000151'
  tag cci: ['CCI-000366']
  tag nist: ['CM-6 b']

  describe parse_config_file("#{input('ui-catalinaPropsPath')}").params['org.apache.catalina.connector.ALLOW_BACKSLASH'] do
