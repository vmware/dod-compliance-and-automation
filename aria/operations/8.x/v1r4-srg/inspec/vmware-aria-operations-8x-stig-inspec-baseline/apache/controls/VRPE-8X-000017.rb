control 'VRPE-8X-000017' do
  title 'The VMware Aria Operations Apache server must display a default hosted application web page, not a directory listing, when a requested web page cannot be found.'
  desc  "
