control 'VRPE-8X-000013' do
  title 'The VMware Aria Operations Apache server accounts accessing the directory tree, the shell, or other operating system functions and utilities must only be administrative accounts.'
