control 'VRPI-8X-000151' do
  title 'The VMware Aria Operations API service must disable "ALLOW_BACKSLASH".'
  ...
  desc  'check', "
    ...
    # grep -i ALLOW_BACKSLASH /usr/lib/vmware-vcops/tomcat-enterprise/conf/catalina.properties
