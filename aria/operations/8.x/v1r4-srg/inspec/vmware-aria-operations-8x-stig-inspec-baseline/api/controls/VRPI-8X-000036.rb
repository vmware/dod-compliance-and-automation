control 'VRPI-8X-000036' do
  title 'The VMware Aria Operations API service must disable stack tracing.'
  ...
  desc  'check', "
    ...
    # xmllint --xpath \"//Connector[@allowTrace]\" /usr/lib/vmware-vcops/tomcat-enterprise/conf/server.xml
  ...
  tag gid: 'V-VRPI-8X-000036'
  tag rid: 'SV-VRPI-8X-000036'
  tag stig_id: 'VRPI-8X-000036'
  tag cci: ['CCI-000381']
  tag nist: ['CM-7 a']
