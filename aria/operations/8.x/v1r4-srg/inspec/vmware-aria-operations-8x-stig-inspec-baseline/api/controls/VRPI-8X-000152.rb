control 'VRPI-8X-000152' do
  title 'The VMware Aria Operations API service must enable "ENFORCE_ENCODING_IN_GET_WRITER".'
  ...
  desc  'check', "
    ...
    # grep ENFORCE_ENCODING_IN_GET_WRITER /usr/lib/vmware-vcops/tomcat-enterprise/conf/catalina.properties
