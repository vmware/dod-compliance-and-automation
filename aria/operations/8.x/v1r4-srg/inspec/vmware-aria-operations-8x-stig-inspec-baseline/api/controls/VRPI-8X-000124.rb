control 'VRPI-8X-000124' do
  title 'The VMware Aria Operations API service must enable "STRICT_SERVLET_COMPLIANCE".'
  desc  "
  ...
  desc  'check', "
    ...
    # grep STRICT_SERVLET_COMPLIANCE /usr/lib/vmware-vcops/tomcat-enterprise/conf/catalina.properties
  ...
  "
  desc 'fix', "
    Navigate to and open the /usr/lib/vmware-vcops/tomcat-enterprise/conf/catalina.properties file.
  ...
  tag gid: 'V-VRPI-8X-000124'
  tag rid: 'SV-VRPI-8X-000124'
  tag stig_id: 'VRPI-8X-000124'
  tag cci: ['CCI-000366']
  tag nist: ['CM-6 b']

  describe parse_config_file("#{input('api-catalinaPropsPath')}").params['org.apache.catalina.STRICT_SERVLET_COMPLIANCE'] do
    it { should cmp 'true' }
  end
end
