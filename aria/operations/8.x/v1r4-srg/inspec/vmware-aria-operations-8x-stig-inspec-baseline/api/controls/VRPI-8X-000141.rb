control 'VRPI-8X-000141' do
  title 'The VMware Aria Operations API service example applications must be removed.'
  ...
  desc  'check', "
    ...
    # ls -l /usr/lib/vmware-vcops/tomcat-enterprise/webapps/examples
  ...
  desc 'fix', "
    ...
    # rm -rf /usr/lib/vmware-vcops/tomcat-enterprise/webapps/examples
  "
  impact 0.5
  tag severity: 'medium'
