control 'VRPI-8X-000013' do
  title 'The VMware Aria Operations API service must initiate session logging upon startup.'
  desc  "
  ...
  tag gid: 'V-VRPI-8X-000013'
  tag rid: 'SV-VRPI-8X-000013'
  tag stig_id: 'VRPI-8X-000013'
  tag cci: ['CCI-001464']
  tag nist: ['AU-14 (1)']

  # look for the startup bootstrap line, and grab the 10 lines before and 2 lines after for comparison
  describe command("grep -B10 -A2 'org.apache.catalina.startup.Bootstrap \"$@\" start ' #{input('api-tcCore')}/bin/catalina.sh") do
