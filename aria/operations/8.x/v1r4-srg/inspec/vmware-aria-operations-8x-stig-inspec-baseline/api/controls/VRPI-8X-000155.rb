control 'VRPI-8X-000155' do
  title 'The VMware Aria Operations API service host-manager webapp must be removed.'
  ...
  desc  'check', "
    ...
    # ls -l /usr/lib/vmware-vcops/tomcat-enterprise/webapps/host-manager
  ...
  desc 'fix', "
    ...
    # rm -rf /usr/lib/vmware-vcops/tomcat-enterprise/webapps/host-manager
  "
  impact 0.5
  tag severity: 'medium'
  tag gtitle: 'SRG-APP-000141-AS-000095'
  tag gid: 'V-VRPI-8X-000155'
  tag rid: 'SV-VRPI-8X-000155'
  tag stig_id: 'VRPI-8X-000155'
  tag cci: ['CCI-000381']
  tag nist: ['CM-7 a']

  # Make sure the host-manager directory does not exist
  describe directory("#{input('api-tcInstance')}/webapps/host-manager").exist? do
    it { should cmp 'false' }
  end
end
