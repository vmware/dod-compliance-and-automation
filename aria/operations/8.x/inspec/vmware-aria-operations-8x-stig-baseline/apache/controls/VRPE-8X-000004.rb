control 'VRPE-8X-000004' do
  title 'The vRealize Operations Manager Apache server must capture, record, and log all content related to a user session.'
  desc  "
