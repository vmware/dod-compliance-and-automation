control 'VRPE-8X-000024' do
  title 'The vRealize Operations Manager Apache server must employ cryptographic mechanisms (TLS/DTLS/SSL) preventing the unauthorized disclosure of information during transmission.'
  desc  "
  ...
  tag satisfies: %w(SRG-APP-000172-WSR-000104 SRG-APP-000439-WSR-000152 SRG-APP-000439-WSR-000156 SRG-APP-000442-WSR-000182)
  tag gid: 'V-VRPE-8X-000024'
  tag rid: 'SV-VRPE-8X-000024'
  tag stig_id: 'VRPE-8X-000024'
  tag cci: %w(CCI-000197 CCI-002418 CCI-002422)
