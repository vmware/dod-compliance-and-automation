control 'VRPP-8X-000035' do
  ...
  tag gid: 'V-VRPP-8X-000035'
  tag rid: 'SV-VRPP-8X-000035'
  tag stig_id: 'VRPP-8X-000035'
  tag cci: %w(CCI-000382 CCI-001762)
  tag nist: ['CM-7 (1) (b)', 'CM-7 b']

  describe command("su - postgres -c '/opt/vmware/vpostgres/current/bin/psql -A -t -c \"SHOW port;\"'") do
