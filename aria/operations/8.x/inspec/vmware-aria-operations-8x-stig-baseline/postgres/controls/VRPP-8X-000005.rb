control 'VRPP-8X-000005' do
  ...
  desc  'check', "
    ...
    # su - postgres -c \"/opt/vmware/vpostgres/current/bin/psql -A -t -c \\\"SHOW shared_preload_libraries;\\\"\"
  ...
  desc 'fix', "
    ...
    # su - postgres -c \"/opt/vmware/vpostgres/current/bin/psql -c \\\"SHOW config_file;\\\"\"
  ...
  describe command("su - postgres -c '/opt/vmware/vpostgres/current/bin/psql -A -t -c \"SHOW shared_preload_libraries;\"'") do
