control 'VRPP-8X-000020' do
  ...
  desc  'rationale', ''
  desc  'check', "
    If PostgreSQL is logging directly to syslog and not storing audit data locally, this control is Not Applicable.
  ...
  describe command("su - postgres -c '/opt/vmware/vpostgres/current/bin/psql -A -t -c \"SHOW log_file_mode;\"'") do
