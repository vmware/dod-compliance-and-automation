control 'VRPS-8X-000014' do
  title 'The Casa service must produce log records containing sufficient information regarding event details.'
  desc  "
  ...
  desc  'check', "
    ...
    # xmllint --xpath '/Server/Service/Engine/Host/Valve[@className=\"org.apache.catalina.valves.AccessLogValve\"]/@pattern' $CATALINA_BASE/conf/server.xml
  ...
  tag satisfies: %w(SRG-APP-000016-AS-000013 SRG-APP-000080-AS-000045 SRG-APP-000089-AS-000050 SRG-APP-000090-AS-000051 SRG-APP-000091-AS-000052 SRG-APP-000096-AS-000059 SRG-APP-000097-AS-000060 SRG-APP-000098-AS-000061 SRG-APP-000099-AS-000062 SRG-APP-000100-AS-000063 SRG-APP-000343-AS-000030 SRG-APP-000375-AS-000211 SRG-APP-000495-AS-000220 SRG-APP-000499-AS-000224 SRG-APP-000503-AS-000228)
  tag gid: 'V-VRPS-8X-000014'
  tag rid: 'SV-VRPS-8X-000014'
  tag stig_id: 'VRPS-8X-000014'
  tag cci: %w(CCI-000067 CCI-000130 CCI-000131 CCI-000132 CCI-000133 CCI-000134 CCI-000166 CCI-000169 CCI-000171 CCI-000172 CCI-001487 CCI-001889 CCI-002234)
  ...
  xmlconf['//*/Valve[@className="org.apache.catalina.valves.AccessLogValve"]/@pattern'].each do |pattern|
    ...
    input('casa-accessLogPattern').each do |item|
      describe pattern do
  ...
  input('casa-contextXmlFiles').each do |context|
