control 'VRPE-8X-000019' do
  title 'The VMware Aria Operations Apache server warning and error messages displayed to clients must be modified to minimize the identity of the web server, patches, loaded modules, and directory paths.'
  desc  "
  ...
  desc  'check', "
    ...
    # grep ServerTokens /usr/lib/vmware-vcopssuite/utilities/conf/vcops-apache.conf | grep -v '^#'
  ...
  tag gid: 'V-VRPE-8X-000019'
  tag rid: 'SV-VRPE-8X-000019'
  tag stig_id: 'VRPE-8X-000019'
  tag cci: ['CCI-001312']
  tag nist: ['SI-11 a']
