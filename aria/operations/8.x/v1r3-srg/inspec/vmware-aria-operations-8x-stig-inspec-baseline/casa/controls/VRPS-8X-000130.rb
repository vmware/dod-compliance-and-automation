control 'VRPS-8X-000130' do
  title 'The VMware Aria Operations Casa service DefaultServlet must be set to "readonly" for "PUT" and "DELETE" commands.'
  desc  "
  ...
  tag gid: 'V-VRPS-8X-000130'
  tag rid: 'SV-VRPS-8X-000130'
  tag stig_id: 'VRPS-8X-000130'
  tag cci: ['CCI-000213']
  tag nist: ['AC-3']
  # Open web.xml
