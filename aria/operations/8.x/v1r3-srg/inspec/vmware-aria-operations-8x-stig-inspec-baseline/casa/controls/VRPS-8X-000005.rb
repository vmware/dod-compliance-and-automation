control 'VRPS-8X-000005' do
  title 'The VMware Aria Operations Casa service cookies must have the secure flag set.'
  desc  "
  ...
  "
  desc 'fix', "
    Edit the /usr/lib/vmware-casa/casa-webapp/conf/web.xml.
  ...
  tag gid: 'V-VRPS-8X-000005'
  tag rid: 'SV-VRPS-8X-000005'
  tag stig_id: 'VRPS-8X-000005'
  tag cci: ['CCI-000213']
  tag nist: ['AC-3']
