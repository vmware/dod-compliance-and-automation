control 'VRPS-8X-000154' do
  title 'The VMware Aria Operations Casa service manager webapp must be removed.'
  ...
  desc  'check', "
    ...
    # ls -l /usr/lib/vmware-casa/casa-webapp/webapps/manager
  ...
  desc 'fix', "
    ...
    # rm -rf /usr/lib/vmware-casa/casa-webapp/webapps/manager
  "
  impact 0.5
  tag severity: 'medium'
  tag gtitle: 'SRG-APP-000141-AS-000095'
  tag gid: 'V-VRPS-8X-000154'
  tag rid: 'SV-VRPS-8X-000154'
  tag stig_id: 'VRPS-8X-000154'
  tag cci: ['CCI-000381']
  tag nist: ['CM-7 a']

  # Make sure the manager directory does not exist
  describe directory("#{input('casa-tcInstance')}/webapps/manager").exist? do
    it { should cmp 'false' }
  end
end
