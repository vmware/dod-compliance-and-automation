control 'VRPS-8X-000126' do
  title 'The VMware Aria Operations Casa service must limit the number of times that each Transmission Control Protocol (TCP) connection is kept alive.'
  desc  "
  ...
  desc  'check', "
    ...
    # xmllint --xpath \"//Connector[@maxKeepAliveRequests = '-1']\" /usr/lib/vmware-casa/casa-webapp/conf/server.xml
