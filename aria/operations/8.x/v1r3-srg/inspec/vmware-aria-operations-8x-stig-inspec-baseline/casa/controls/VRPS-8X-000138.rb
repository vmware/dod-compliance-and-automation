control 'VRPS-8X-000138' do
  title 'The VMware Aria Operations Casa service deployXML attribute must be disabled.'
  desc  "
  ...
  desc  'check', "
    ...
    # xmllint --xpath \"//Host/@deployXML\" /usr/lib/vmware-casa/casa-webapp/conf/server.xml
