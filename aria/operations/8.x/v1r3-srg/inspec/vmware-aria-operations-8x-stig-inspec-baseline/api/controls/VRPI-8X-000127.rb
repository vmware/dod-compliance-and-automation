control 'VRPI-8X-000127' do
  title 'The VMware Aria Operations API service must configure the "setCharacterEncodingFilter" filter.'
  desc  "
  ...
  desc  'check', "
    ...
    # xmllint --xpath \"//*[contains(text(), 'SetCharacterEncodingFilter')]/parent::*\" /usr/lib/vmware-vcops/tomcat-enterprise/conf/web.xml
  ...
  tag gid: 'V-VRPI-8X-000127'
  tag rid: 'SV-VRPI-8X-000127'
  tag stig_id: 'VRPI-8X-000127'
  tag cci: ['CCI-001310']
  tag nist: ['SI-10']
  # Open web.xml
