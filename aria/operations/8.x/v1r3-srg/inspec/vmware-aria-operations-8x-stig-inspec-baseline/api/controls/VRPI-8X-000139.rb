control 'VRPI-8X-000139' do
  title 'The VMware Aria Operations API service must have Autodeploy disabled.'
  ...
  desc  'check', "
    ...
    # xmllint --xpath \"//Host/@autoDeploy\" /usr/lib/vmware-vcops/tomcat-enterprise/conf/server.xml
