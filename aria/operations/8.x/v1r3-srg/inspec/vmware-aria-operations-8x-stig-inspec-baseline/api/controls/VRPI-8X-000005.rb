control 'VRPI-8X-000005' do
  title 'The VMware Aria Operations API service cookies must have secure flag set.'
  desc  "
    ...
    The /usr/lib/vmware-vcops/tomcat-enterprise/conf/web.xml file controls how each application handles cookies via the <cookie-config> element.
  "
  desc  'rationale', ''
  desc  'check', "
    At the command prompt, run the following command:

    xmllint --xpath \"//*[local-name()='cookie-config']/parent::*\" /usr/lib/vmware-vcops/tomcat-enterprise/conf/web.xml
  ...
  "
  desc 'fix', "
    Edit the /usr/lib/vmware-vcops/tomcat-enterprise/conf/web.xml.
  ...
  tag gid: 'V-VRPI-8X-000005'
  tag rid: 'SV-VRPI-8X-000005'
  tag stig_id: 'VRPI-8X-000005'
  tag cci: ['CCI-000213']
  tag nist: ['AC-3']
