control 'VRPI-8X-000067' do
  title 'The VMware Aria Operations API service "ErrorReportValve showServerInfo" must be set to "false".'
  ...
  desc  'check', "
    ...
    # xmllint --xpath \"//*[contains(@className, 'ErrorReportValve')]/parent::*\" /usr/lib/vmware-vcops/tomcat-enterprise/conf/server.xml
  ...
  tag gid: 'V-VRPI-8X-000067'
  tag rid: 'SV-VRPI-8X-000067'
  tag stig_id: 'VRPI-8X-000067'
  tag cci: ['CCI-001312']
  tag nist: ['SI-11 a']
