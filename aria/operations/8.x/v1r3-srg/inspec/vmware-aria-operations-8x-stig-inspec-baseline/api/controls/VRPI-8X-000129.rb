control 'VRPI-8X-000129' do
  title 'The VMware Aria Operations API service cookies must have the "http-only" flag set.'
  ...
  tag gid: 'V-VRPI-8X-000129'
  tag rid: 'SV-VRPI-8X-000129'
  tag stig_id: 'VRPI-8X-000129'
  tag cci: ['CCI-000213']
  tag nist: ['AC-3']
