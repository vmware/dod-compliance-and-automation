control 'VRPI-8X-000140' do
  title 'The VMware Aria Operations API service xpoweredBy attribute must be disabled.'
  ...
  desc  'check', "
    ...
    # xmllint --xpath \"//Connector/@xpoweredBy\" /usr/lib/vmware-vcops/tomcat-enterprise/conf/server.xml
  ...
  tag gid: 'V-VRPI-8X-000140'
  tag rid: 'SV-VRPI-8X-000140'
  tag stig_id: 'VRPI-8X-000140'
  tag cci: ['CCI-000381']
  tag nist: ['CM-7 a']
