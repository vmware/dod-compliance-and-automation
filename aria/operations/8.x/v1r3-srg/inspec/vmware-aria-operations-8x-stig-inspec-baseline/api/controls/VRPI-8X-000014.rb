control 'VRPI-8X-000014' do
  title 'The VMware Aria Operations API service must produce log records containing sufficient information regarding event details.'
  desc  "
  ...
  desc  'check', "
    ...
    # xmllint --xpath '/Server/Service/Engine/Host/Valve[@className=\"org.apache.catalina.valves.AccessLogValve\"]/@pattern' /usr/lib/vmware-vcops/tomcat-enterprise/conf/server.xml
  ...
  "
  desc 'fix', "
    Navigate to and open the /usr/lib/vmware-vcops/tomcat-enterprise/conf/server.xml file.
