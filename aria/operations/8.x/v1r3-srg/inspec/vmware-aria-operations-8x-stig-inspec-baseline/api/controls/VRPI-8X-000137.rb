control 'VRPI-8X-000137' do
  title 'The VMware Aria Operations API service directory listings parameter must be disabled.'
  desc  "
  ...
  desc  'check', "
    ...
    # xmllint --xpath \"//*[contains(text(), 'DefaultServlet')]/parent::*\" /usr/lib/vmware-vcops/tomcat-enterprise/conf/web.xml
  ...
  "
  desc 'fix', "
    Navigate to and open the /usr/lib/vmware-vcops/tomcat-enterprise/conf/web.xml file.
  ...
  tag gid: 'V-VRPI-8X-000137'
  tag rid: 'SV-VRPI-8X-000137'
  tag stig_id: 'VRPI-8X-000137'
  tag cci: ['CCI-000381']
  tag nist: ['CM-7 a']
