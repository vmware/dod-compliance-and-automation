control 'VRPI-8X-000065' do
  title 'The VMware Aria Operations API service must set URIEncoding to UTF-8.'
  desc  "
  ...
  desc  'check', "
    ...
    # xmllint --xpath \"//Connector[not(@URIEncoding)] | //Connector[@URIEncoding != 'UTF-8']\" /usr/lib/vmware-vcops/tomcat-enterprise/conf/server.xml | awk 1 RS='<Connector' ORS='\
    <Connector'
