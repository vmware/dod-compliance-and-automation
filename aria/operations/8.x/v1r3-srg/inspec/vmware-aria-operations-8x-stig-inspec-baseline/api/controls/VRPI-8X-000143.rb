control 'VRPI-8X-000143' do
  title 'The VMware Aria Operations API service default documentation must be removed.'
  ...
  desc  'check', "
    ...
    # ls -l /usr/lib/vmware-vcops/tomcat-enterprise/webapps/docs
  ...
  desc 'fix', "
    ...
    # rm -rf /usr/lib/vmware-vcops/tomcat-enterprise/webapps/docs
  "
  impact 0.5
  tag severity: 'medium'
