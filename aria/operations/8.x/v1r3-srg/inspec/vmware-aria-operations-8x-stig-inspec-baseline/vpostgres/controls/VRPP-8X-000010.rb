control 'VRPP-8X-000010' do
  title 'VMware Aria Operations vPostgres must produce logs containing sufficient information to establish what type of events occurred.'
  desc  "
  ...
  desc 'fix', "
    ...
    # su - postgres -c \"/opt/vmware/vpostgres/current/bin/psql -p 5433 -c \\\"ALTER SYSTEM SET log_line_prefix = '%m %c %x %d %u %r %p %l';\\\"\"
