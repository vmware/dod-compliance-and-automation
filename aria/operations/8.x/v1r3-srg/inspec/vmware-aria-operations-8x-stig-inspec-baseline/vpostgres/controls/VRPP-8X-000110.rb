control 'VRPP-8X-000110' do
  title 'VMware Aria Operations vPostgres must log all connection attempts.'
  ...
  describe command("su - postgres -c '/opt/vmware/vpostgres/current/bin/psql -p 5433 -A -t -c \"SHOW log_connections;\"'") do
