control 'VRPU-8X-000140' do
  title 'The VMware Aria Operations UI service xpoweredBy attribute must be disabled.'
  ...
  desc  'check', "
    ...
    # xmllint --xpath \"//Connector/@xpoweredBy\" /usr/lib/vmware-vcops/tomcat-web-app/conf/server.xml
  ...
  tag gid: 'V-VRPU-8X-000140'
  tag rid: 'SV-VRPU-8X-000140'
  tag stig_id: 'VRPU-8X-000140'
  tag cci: ['CCI-000381']
  tag nist: ['CM-7 a']
