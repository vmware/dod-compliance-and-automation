control 'VRPU-8X-000067' do
  title 'The VMware Aria Operations UI service "ErrorReportValve showServerInfo" must be set to "false".'
  ...
  desc  'check', "
    ...
    # xmllint --xpath \"//*[contains(@className, 'ErrorReportValve')]/parent::*\" /usr/lib/vmware-vcops/tomcat-web-app/conf/server.xml
