control 'VRPU-8X-000129' do
  title 'The VMware Aria Operations UI service cookies must have the "http-only" flag set.'
  ...
  tag gid: 'V-VRPU-8X-000129'
  tag rid: 'SV-VRPU-8X-000129'
  tag stig_id: 'VRPU-8X-000129'
  tag cci: ['CCI-000213']
  tag nist: ['AC-3']
