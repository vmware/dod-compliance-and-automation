control 'VRPU-8X-000125' do
  title 'The VMware Aria Operations UI service must limit the amount of time that each Transmission Control Protocol (TCP) connection is kept alive.'
  desc  "
  ...
  desc  'check', "
    ...
    # xmllint --xpath \"//Connector[@connectionTimeout = '-1']\" /usr/lib/vmware-vcops/tomcat-web-app/conf/server.xml
