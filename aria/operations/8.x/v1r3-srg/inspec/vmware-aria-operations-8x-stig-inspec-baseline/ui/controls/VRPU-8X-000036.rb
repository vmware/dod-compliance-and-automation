control 'VRPU-8X-000036' do
  title 'The VMware Aria Operations UI service must disable stack tracing.'
  ...
  desc  'check', "
    ...
    # xmllint --xpath \"//Connector[@allowTrace]\" /usr/lib/vmware-vcops/tomcat-web-app/conf/server.xml
  ...
  tag gid: 'V-VRPU-8X-000036'
  tag rid: 'SV-VRPU-8X-000036'
  tag stig_id: 'VRPU-8X-000036'
  tag cci: ['CCI-000381']
  tag nist: ['CM-7 a']
