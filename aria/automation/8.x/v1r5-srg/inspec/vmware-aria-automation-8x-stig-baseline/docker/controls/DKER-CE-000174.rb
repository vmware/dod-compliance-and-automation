control 'DKER-CE-000174' do
  ...
  desc  "
    IPC (POSIX/SysV IPC) namespace provides separation of named shared memory segments, semaphores, and message queues. IPC namespace on the host thus must not be shared with the containers and must remain isolated.
  ...
  tag gid: 'V-DKER-CE-000174'
  tag rid: 'SV-DKER-CE-000174'
  tag stig_id: 'DKER-CE-000174'
  tag cci: ['CCI-001368']
  tag nist: ['AC-4']
