control 'VRAA-8X-000123' do
  title 'VMware Aria Automation must disable the Customer Experience Improvement Program (CEIP).'
  ...
  desc 'fix', "
    ...
    Note: The VMware Aria Automation services must be restarted for the command to take effect.
  "
  impact 0.5
  tag severity: 'medium'
