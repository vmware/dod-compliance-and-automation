control 'DKER-CE-000184' do
  ...
  desc  "
    The aufs storage driver is based on an older Linux kernel patch set that is known to cause kernel crashes.
  ...
  tag gid: 'V-DKER-CE-000184'
  tag rid: 'SV-DKER-CE-000184'
