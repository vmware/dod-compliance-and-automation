control 'DKER-CE-000194' do
  ...
  desc  "Using the --restart flag in docker run command, a restart policy must be specified that controls how a container is or is not restarted on exit. Choose the on-failure restart policy and limit the restart attempts to 5.
