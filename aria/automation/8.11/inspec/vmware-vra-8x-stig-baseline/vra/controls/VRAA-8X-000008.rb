control 'VRAA-8X-000008' do
  title 'vRealize Automation must configure log shipping to an external system.'
  desc  "
  ...
  desc  'rationale', ''
  desc  'check', "
    On the vRA appliance, at the command line interface, run one of the following commands:
  ...
  if syslogconfig.stdout.length.positive?
    ...
    jsoncontent.each do |_key, value|
      describe value do
