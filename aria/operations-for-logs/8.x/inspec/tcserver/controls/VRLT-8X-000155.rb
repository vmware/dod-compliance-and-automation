control 'VRLT-8X-000155' do
  title 'The VMware Aria Operations for Logs tc Server host-manager webapp must be removed.'
  ...
  tag gid: 'V-VRLT-8X-000155'
  tag rid: 'SV-VRLT-8X-000155'
  tag stig_id: 'VRLT-8X-000155'
  tag cci: ['CCI-000381']
  tag nist: ['CM-7 a']
