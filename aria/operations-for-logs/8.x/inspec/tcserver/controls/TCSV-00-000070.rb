control 'TCSV-00-000070' do
  title 'tc Server must set an inactive timeout for sessions.'
  desc  "
  ...
  tag gid: 'V-TCSV-00-000070'
  tag rid: 'SV-TCSV-00-000070'
  tag stig_id: 'TCSV-00-000070'
