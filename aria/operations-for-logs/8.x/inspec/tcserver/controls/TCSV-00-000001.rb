control 'TCSV-00-000001' do
  title 'tc Server must limit the number of maximum concurrent connections permitted.'
  desc  "
  ...
  tag gid: 'V-TCSV-00-000001'
  tag rid: 'SV-TCSV-00-000001'
  tag stig_id: 'TCSV-00-000001'
  tag cci: ['CCI-000054']
  tag nist: ['AC-10']
