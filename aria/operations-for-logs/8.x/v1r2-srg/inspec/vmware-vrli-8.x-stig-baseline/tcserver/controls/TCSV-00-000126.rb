control 'TCSV-00-000126' do
  title 'tc Server must limit the number of times that each TCP connection is kept alive.'
  desc  "
  ...
  desc  'check', "
    ...
    #  xmllint --format --xpath \"//Connector[not(@maxKeepAliveRequests)] | //Connector[@maxKeepAliveRequests != '15']\" $CATALINA_BASE/conf/server.xml | awk 1 RS='</Connector>' ORS='</Connector>\
    '
  ...
  tag gid: 'V-TCSV-00-000126'
  tag rid: 'SV-TCSV-00-000126'
  tag stig_id: 'TCSV-00-000126'
  tag cci: ['CCI-000054']
  tag nist: ['AC-10']
