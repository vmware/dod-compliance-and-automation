control 'TCSV-00-000131' do
  ...
  desc  'check', "
    ...
    # xmllint --xpath \"//Connector[not(@scheme)] | //Connector[@scheme != 'https']\" $CATALINA_BASE/conf/server.xml
    # xmllint --xpath \"//Connector[not(@secure)] | //Connector[@secure!= 'true']\" $CATALINA_BASE/conf/server.xml
  ...
  tag gid: 'V-TCSV-00-000131'
  tag rid: 'SV-TCSV-00-000131'
  tag stig_id: 'TCSV-00-000131'
  tag cci: ['CCI-000213']
  tag nist: ['AC-3']
