control 'TCSV-00-000125' do
  title 'tc Server must limit the amount of time that each TCP connection is kept alive.'
  desc  "
  ...
  desc  'check', "
    ...
    #  xmllint --format --xpath \"//Connector[not(@connectionTimeout)] | //Connector[@connectionTimeout != '20000']\" $CATALINA_BASE/conf/server.xml | awk 1
  ...
  tag gid: 'V-TCSV-00-000125'
  tag rid: 'SV-TCSV-00-000125'
  tag stig_id: 'TCSV-00-000125'
  tag cci: ['CCI-000054']
  tag nist: ['AC-10']
