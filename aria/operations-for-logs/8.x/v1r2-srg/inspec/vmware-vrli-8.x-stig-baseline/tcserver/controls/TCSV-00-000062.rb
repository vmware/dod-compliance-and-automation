control 'TCSV-00-000062' do
  title 'tc Server must be built to fail to a known safe state if system initialization fails, shutdown fails, or aborts fail.'
  ...
  tag gid: 'V-TCSV-00-000062'
  tag rid: 'SV-TCSV-00-000062'
  tag stig_id: 'TCSV-00-000062'
  tag cci: ['CCI-001190']
  tag nist: ['SC-24']
