control 'VRLT-8X-000004' do
  title 'The VMware Aria Operations for Logs tc Server must have logging configured for each application context.'
  desc  "
  ...
  desc  'check', "
    ...
    # xmllint --xpath \"//Valve[contains(@className, 'AccessLogValve')]/parent::*\" /usr/lib/loginsight/application/3rd_party/apache-tomcat/conf/server.xml
  ...
  tag satisfies: ['SRG-APP-000090-AS-000051', 'SRG-APP-000495-AS-000220', 'SRG-APP-000499-AS-000224', 'SRG-APP-000503-AS-000228']
  tag gid: 'V-VRLT-8X-000004'
  tag rid: 'SV-VRLT-8X-000004'
  tag stig_id: 'VRLT-8X-000004'
  tag cci: ['CCI-000067', 'CCI-000171', 'CCI-000172']
