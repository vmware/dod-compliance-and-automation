control 'VRLT-8X-000014' do
  title 'The VMware Aria Operations for Logs tc Server must produce log records containing sufficient information regarding event details.'
  desc  "
    After a security incident has occurred, investigators will often review log files to determine what happened. The tc Server must create a log entry when users access the system, and the system authenticates the users.
  ...
  desc  'check', "
    ...
    # xmllint --xpath \"//*[contains(@className, 'AccessLogValve')]/parent::*\" /usr/lib/loginsight/application/3rd_party/apache-tomcat/conf/server.xml
  ...
  tag satisfies: ['SRG-APP-000080-AS-000045', 'SRG-APP-000089-AS-000050', 'SRG-APP-000091-AS-000052', 'SRG-APP-000096-AS-000059', 'SRG-APP-000097-AS-000060', 'SRG-APP-000098-AS-000061', 'SRG-APP-000099-AS-000062', 'SRG-APP-000100-AS-000063', 'SRG-APP-000343-AS-000030', 'SRG-APP-000375-AS-000211']
  tag gid: 'V-VRLT-8X-000014'
  tag rid: 'SV-VRLT-8X-000014'
  tag stig_id: 'VRLT-8X-000014'
  tag cci: ['CCI-000130', 'CCI-000131', 'CCI-000132', 'CCI-000133', 'CCI-000134', 'CCI-000166', 'CCI-000169', 'CCI-000172', 'CCI-001487', 'CCI-001889', 'CCI-002234']
