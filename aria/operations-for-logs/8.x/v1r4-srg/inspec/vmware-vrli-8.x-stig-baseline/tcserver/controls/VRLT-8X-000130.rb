control 'VRLT-8X-000130' do
  title 'The VMware Aria Operations for Logs tc Server DefaultServlet must be set to readonly for PUT and DELETE.'
  desc  "
  ...
  tag gid: 'V-VRLT-8X-000130'
  tag rid: 'SV-VRLT-8X-000130'
  tag stig_id: 'VRLT-8X-000130'
  tag cci: ['CCI-000213']
  tag nist: ['AC-3']
