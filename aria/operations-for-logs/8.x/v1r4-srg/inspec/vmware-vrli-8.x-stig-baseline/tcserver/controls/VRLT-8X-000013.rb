control 'VRLT-8X-000013' do
  title 'The VMware Aria Operations for Logs tc Server must initiate session logging upon startup.'
  desc  "
  ...
  "
  desc 'fix', "
    Edit the /usr/lib/loginsight/application/etc/3rd_config/catalina.sh file.
  ...
  tag gid: 'V-VRLT-8X-000013'
  tag rid: 'SV-VRLT-8X-000013'
  tag stig_id: 'VRLT-8X-000013'
  tag cci: ['CCI-001464']
  tag nist: ['AU-14 (1)']
