control 'VRLT-8X-000057' do
  title 'The VMware Aria Operations for Logs tc Server must be configured to limit data exposure between applications.'
  ...
  tag gid: 'V-VRLT-8X-000057'
  tag rid: 'SV-VRLT-8X-000057'
  tag stig_id: 'VRLT-8X-000057'
