control 'VRLT-8X-000127' do
  title 'The VMware Aria Operations for Logs tc Server must set the setCharacterEncodingFilter filter.'
  desc  "
  ...
  tag gid: 'V-VRLT-8X-000127'
  tag rid: 'SV-VRLT-8X-000127'
  tag stig_id: 'VRLT-8X-000127'
  tag cci: ['CCI-001310']
  tag nist: ['SI-10']
