...
# VMware Aria Operations for Logs 8.x STIG Documentation
...
## Intended Audience
The audience for the VMware Aria Operations for Logs 8.x STIG and/or STIG Readiness Guides is VMware Aria Operations for Logs 8.x customers in the DOD needing to harden and accredit their vSphere environments. Other entities can use this guidance, however there are items that are specific to the DOD that will not be applicable to a non-DOD environment.
...
|:-----------------:|:------------------:|:------------------:|:------------------:|
|     `V1R2`        |STIG Readiness Guide|     2023/12/20     |[U_VMware_Aria_Operations_for_Logs_8.x_STIG_Readiness_Guide_v1r2.zip](U_VMware_Aria_Operations_for_Logs_8.x_STIG_Readiness_Guide_v1r2.zip)|
|     `V1R4`        |STIG Readiness Guide|     2024/02/21     |[U_VMware_Aria_Operations_for_Logs_8.x_STIG_Readiness_Guide_v1r4.zip](U_VMware_Aria_Operations_for_Logs_8.x_STIG_Readiness_Guide_v1r4.zip)|
